...
package Modelica_StateGraph2
  annotation (uses(Modelica(version="3.1")),
    ...
    version="2.0",
    versionBuild=5,
    versionDate="2009-09-10",
    dateModified = "2009-09-10 09:37:00Z",
    revisionId="$Id:: package.mo 2904 2009-09-10 07:36:57Z #$",
    ...
    "Examples to demonstrate how to use the interactive blocks"
      ...
      "Example to demonstrate the usage of RadioButtonSource components"
        ...
        Modelica_StateGraph2.Blocks.Interactive.RadioButtonSource shut(
          ...
          buttonTimeTable={5})
          annotation (Placement(transformation(extent={{-60,-20.5},{-40,-0.5}},
                  rotation=0)));
      equation

      annotation (experiment(StopTime=6), experimentSetupOutput);
...
\"animationSpeed(speed = 50)\".
          ...
          Modelica_StateGraph2.Blocks.Interactive.RadioButtonSource shut(
                                                           reset={start.on,stop.on},
            buttonTimeTable={700})
            annotation (Placement(transformation(extent={{-100,-40.5},{-80,
                  -20.5}},
                    rotation=0)));
...
<li> The controller is hierarchically structured for the different tasks.</li>
        ...
        equation
          connect(level1.y, bus.level1) annotation (Line(
              points={{-51.75,-53},{-34,-53},{-34,-2},{-30,-2},{-30,-1},{-32,-1},{-32,0}},
              color={0,0,127},
        ...
        package Internal "Utility components for the examples"
          partial model PartialControlledTank
            ...
            massDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial)
                      ...
                      50,80}},       rotation=0)));
            Modelica.Fluid.Valves.ValveDiscrete valve2(        redeclare
              package Medium =
                  Medium,
              ...
              annotation (Placement(transformation(
                  ...
                  extent={{10,-10},{-10,10}},
                  rotation=90)));
            Modelica.Fluid.Valves.ValveDiscrete valve3(        redeclare
              package Medium =
                  Medium,
              dp_nominal(displayUnit="Pa") = 1,
              m_flow_nominal=10)
            ...
            inner Modelica.Fluid.System system
                                  annotation (Placement(transformation(extent={{-73,70},
                    {-53,90}},   rotation=0)));
          equation
          ...
          "Controller 1 for tank system (using expressions to control the valves)"
            ...
            Modelica.Blocks.Interfaces.BooleanInput start
              annotation (Placement(transformation(extent={{-130,50},{-110,70}},
                      rotation=0), iconTransformation(extent={{-120,50},{-100,70}})));
            ...
            Modelica.Blocks.Interfaces.BooleanInput shut
              annotation (Placement(transformation(extent={{-130,-70},{-110,-50}},
                      rotation=0), iconTransformation(extent={{-120,-70},{-100,
                      -50}})));
            ...
            Modelica.Blocks.Sources.BooleanExpression setValve1(y=fillTank1.active
              ...
              annotation (Placement(transformation(extent={{-14,-99},{67,-83}},
                      rotation=0)));
            Modelica.Blocks.Sources.BooleanExpression setValve2(y=(fillTank2.active
                  ...
                  limit2)
              annotation (Placement(transformation(extent={{-78,-119},{67,-101}},
                      rotation=0)));
            Modelica.Blocks.Sources.BooleanExpression setValve3(y=emptyTanks.active
                   or shutTank2.active)
              annotation (Placement(transformation(extent={{-23,-136},{67,-120}},
                      rotation=0)));
            ...
            Modelica_StateGraph2.Transition T13(
                           delayedTransition=false, condition=level1 < minLevel)
                             annotation (Placement(transformation(extent={{-50,-29},
                      {-42,-21}})));
            Parallel shutStep(
              use_inPort=true,
              use_outPort=true,
            ...
            Modelica_StateGraph2.Transition T11(
                           condition=level2 < minLevel, delayedTransition=false)
                             annotation (Placement(transformation(extent={{-23,-29},
                      {-15,-21}})));
            ...
            Modelica_StateGraph2.Step stopStep2(
                           nIn=1, nOut=1) annotation (Placement(transformation(
                    extent={{-85,-32},{-77,-24}})));
            Modelica_StateGraph2.Transition T15(
              use_conditionPort=true,
            delayedTransition=false,
            waitTime=0)               annotation (Placement(transformation(extent=
                     {{-85,-43},{-77,-35}})));
          ...
          Modelica_StateGraph2.Step shutWait2(
                                    nOut=1, nIn=1) annotation (Placement(
                transformation(extent={{-85,-57},{-77,-49}})));
            Modelica_StateGraph2.Transition T18(
              waitTime=0.01,
              delayedTransition=true,
            use_conditionPort=false)  annotation (Placement(transformation(extent={{-85,-71},
                    {-77,-63}})));
          equation
            ...
            connect(T6.outPort, startStep.inPort[2]) annotation (Line(
                points={{41,-61},{41,-66},{47.2443,-66},{50.7324,-66},{63,-66},
                  {63,-52.3225},{63,94.9863},{63,109},{52.0055,109},{48.0088,
                  109},{42,109},{42,104}},
                color={0,0,0},
                smooth=Smooth.Bezier));
            ...
            connect(makeProduct.suspend[1], T8.inPort) annotation (Line(
                points={{21.75,82.9063},{-10.4644,82.9063},{-29,82.9063},{-29,
                  76}},
                color={0,0,0},
                smooth=Smooth.Bezier));
            connect(stop, T8.conditionPort) annotation (Line(
                points={{-120,0},{-100,0},{-100,13.2324},{-100,36.7148},{-100,
                  50},{-87.2871,50},{-64.0121,50},{-54,50},{-54,60},{-34,60},{
                  -34,72}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            ...
            connect(T10.inPort, stopStep1.outPort[2])
                                                     annotation (Line(
                points={{10,34},{10,48},{-2.41211,48},{-21,48},{-28,48},{-28,
                  52.4}},
                color={0,0,0},
                smooth=Smooth.Bezier));
            ...
            connect(setValve2.y, valve2) annotation (Line(
                points={{74.25,-110},{85,-110},{85,-98.0166},{85,-16.3281},{85,
                  0},{105,0}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            connect(setValve3.y, valve3) annotation (Line(
                points={{71.5,-128},{78.4917,-128},{90,-128},{90,-116.313},{90,
                  -72.2635},{90,-60},{105,-60}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            connect(start, T10.conditionPort) annotation (Line(
                points={{-120,60},{-120,60},{-70.0195,60},{-60,60},{-60,70},{
                  -50.5273,70},{-24.0104,70},{-10,70},{-10,57.7539},{-10,42.5},
                  {-10,30},{5,30}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            connect(shutStep.entry[1], shutTank1.inPort[1]) annotation (Line(
                points={{-31.4,2.55},{-31.4,-1},{-35.7486,-1},{-41.2447,-1},{
                  -46,-1},{-46,-6}},
                color={0,0,0},
                smooth=Smooth.Bezier));
            connect(shutStep.entry[2], shutTank2.inPort[1]) annotation (Line(
                points={{-28.6,2.55},{-28.6,-1},{-25.2531,-1},{-23.2502,-1},{
                  -19,-1},{-19,-6}},
                color={0,0,0},
                smooth=Smooth.Bezier));
            ...
            connect(tank1Empty.outPort[1], shutStep.exit[1]) annotation (Line(
                points={{-46,-47.6},{-46,-52},{-41,-52},{-31.4,-52},{-31.4,
                  -59.9813}},
                color={0,0,0},
                smooth=Smooth.Bezier));
            connect(tank2Empty.outPort[1], shutStep.exit[2]) annotation (Line(
                points={{-19,-47.6},{-19,-52},{-23.2469,-52},{-28.6,-52},{-28.6,
                  -59.9813}},
                color={0,0,0},
                smooth=Smooth.Bezier));
            connect(shutStep.outPort[1], T12.inPort) annotation (Line(
                points={{-30,-63.8625},{-30,-74},{-20.0098,-74},{-3.51645,-74},
                  {3,-74},{3,-70}},
                color={0,0,0},
                smooth=Smooth.Bezier));
            connect(shutStep.suspend[1], T14.inPort) annotation (Line(
                points={{-59.4,-9.09375},{-76.2328,-9.09375},{-81,-9.09375},{
                  -81,-12}},
                color={0,0,0},
                smooth=Smooth.Bezier));
            ...
            connect(stop, T14.conditionPort) annotation (Line(
                points={{-120,0},{-100,0},{-100,-8},{-100,-16},{-91.5098,-16},{
                  -86,-16}},
                color={255,0,255},
                smooth=Smooth.Bezier));
          ...
          connect(T18.outPort, shutStep.resume[1]) annotation (Line(
              points={{-81,-72},{-81,-79},{-72.1514,-79},{-64,-79},{-64,
                  -69.1522},{-64,-56.5907},{-64,-47.9063},{-58,-47.9063}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          end TankController1;
          ...
          Modelica_StateGraph2.Step waitShut(
                                   nIn=1, nOut=1) annotation (Placement(
                transformation(extent={{-24,-22},{-16,-14}})));
          Modelica_StateGraph2.Transition T1(
                                   delayedTransition=true, waitTime=0.01)
          ...
          Modelica_StateGraph2.Step waitShut2(
                                    nIn=1, nOut=1) annotation (Placement(
                transformation(extent={{-69,-76},{-61,-68}})));
          Modelica_StateGraph2.Transition T3(
                                   delayedTransition=true, waitTime=0.01)
          ...
          equation
            ...
            connect(stopStep2.outPort[1], T15.inPort) annotation (Line(
                ...
                smooth=Smooth.Bezier));
            connect(makeProduct.suspend[1], T8.inPort) annotation (Line(
                points={{19.2,12},{10,12},{10,21.9873},{10,33},{-0.494685,33},{
                  -11.9766,33},{-19,33},{-19,27}},
                color={0,0,0},
                smooth=Smooth.Bezier));
            connect(shutStep.suspend[1], T14.inPort) annotation (Line(
                ...
                smooth=Smooth.Bezier));
            connect(shutStep.outPort[1], T12.inPort) annotation (Line(
                points={{-19.9,-85.7},{-20,-92},{-26,-98},{-66,-98},{-75,-95},{
                  -76,-86},{-76,-2}},
                color={0,0,0},
                smooth=Smooth.Bezier));
            connect(T12.outPort, makeProduct.inPort[1]) annotation (Line(
                points={{-76,7},{-76,7},{-76,27},{-76,43},{-57,43},{21,43},{40,42},{40,20}},
                color={0,0,0},
                smooth=Smooth.Bezier));
          ...
          connect(T3.outPort, shutStep.resume[1]) annotation (Line(
              points={{-65,-90},{-65,-90},{-65,-95},{-60,-95},{-46,-95},{-46,
                  -90},{-47,-76},{-40.05,-77}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(makeProduct.valve3, setValve3.u[1]) annotation (Line(
              points={{61,6},{77,6},{77,-30},{40,-30},{40,-55},{51,-55},{51,
                  -53.9}},
              color={255,0,255},
              smooth=Smooth.None));
          ...
          model MakeProduct
            ...
            "Value of Boolean output"
              annotation (Placement(transformation(extent={{100,70},{120,90}}),
                  iconTransformation(extent={{200,144},{220,164}})));
            Modelica.Blocks.Interfaces.BooleanOutput valve2
            "Value of Boolean output"
              annotation (Placement(transformation(extent={{100,50},{120,70}}),
                  iconTransformation(extent={{200,96},{220,116}})));
            Modelica.Blocks.Interfaces.BooleanOutput valve3
            "Value of Boolean output"
          ...
          model ShutStep
            ...
            annotation (Diagram(coordinateSystem(
                  ...
                  extent={{-100,-100},{100,100}},
                  grid={1,1}), graphics),
                                 Icon(coordinateSystem(preserveAspectRatio=true, extent={{-200,
                    -200},{200,200}}), graphics={
                Text(
            ...
            Modelica_StateGraph2.Transition T13(
                           delayedTransition=false, condition=bus.level1 < minLevel)
                             annotation (Placement(transformation(extent={{-20,37},{-12,
                      45}})));
            Modelica_StateGraph2.Step shutTank2(
                           nIn=1, nOut=1,
            initialStep=false,
            ...
            "Value of Boolean output"
              annotation (Placement(transformation(extent={{100,70},{120,90}}),
                  iconTransformation(extent={{200,124},{220,144}})));
            Modelica.Blocks.Interfaces.BooleanOutput valve3
            "Value of Boolean output"
              annotation (Placement(transformation(extent={{100,40},{120,60}}),
                  iconTransformation(extent={{200,68},{220,88}})));
          equation
            connect(shutTank1.outPort[1],T13. inPort) annotation (Line(
            ...
            connect(tank1Empty.outPort[1], exit[1]) annotation (Line(
                points={{-16,18.4},{-16,-40.8},{-16,-79.483},{-16,-105},{-30,
                  -105}},
                color={0,0,0},
                smooth=Smooth.Bezier));
      ...
      package ProductionLine "Production line with simple robots"
        model MainSimple
          ...
          annotation (Diagram(coordinateSystem(
              ...
              Text(
                ...
                lineColor={0,0,0},
                textString="Next.Ready"),
              Text(
                extent={{-110,64},{-110,56}},
                lineColor={0,0,0},
                textString="Next.Idle"),
              Text(
                extent={{-120,46},{-120,38}},
                lineColor={0,0,0},
                textString="Next.Transport"),
              Text(
                extent={{124,30},{124,22}},
                lineColor={0,0,0},
                textString="Prev.Transport off"),
              Text(
                extent={{108,44},{108,36}},
                lineColor={0,0,0},
                textString="Prev.Idle"),
              Text(
          ...
          startTable                   annotation (Placement(transformation(extent={{-60,34},
                  {-40,54}},          rotation=0)));
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TableHorizontal
          table
            annotation (Placement(transformation(extent={{-40,34},{-20,54}},rotation=
                    0)));
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TableHorizontal
          table1
            annotation (Placement(transformation(extent={{-20,34},{0,54}},rotation=0)));
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TableHorizontal
          table2
          ...
          endTable                 annotation (Placement(transformation(extent={{40,34},
                  {60,54}},   rotation=0)));
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TableHorizontal
          table3
          ...
          robot
            annotation (Placement(transformation(extent={{-20,34},{0,60}},rotation=0)));
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Utilities.RobotHorizontal
          robot1
          ...
          robotTermHorizontal
            annotation (Placement(transformation(extent={{-40,34},{-20,60}},rotation=
                    0)));
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Utilities.RobotComTerm
          robotComTerm                          annotation (Placement(transformation(
                  extent={{20,14},{40,34}}, rotation=0)));
        ...
        equation
          connect(startTable.tableComNext, table.tableComPrev) annotation (Line(
                points={{-42,37},{-40,37},{-38,37}},                           color=
                  {0,0,0}));
          connect(table.robotComTable, robotTermHorizontal.robotComRobot)
            annotation (Line(points={{-32,37},{-31.1538,37},{-28,37}},
                                     color={0,0,0}));
          connect(table2.robotComTable, robot1.robotComRobot) annotation (Line(points={{8,37},{
                8.84615,37},{12,37}},
                color={0,0,0}));
          connect(table2.tableComNext, table3.tableComPrev) annotation (Line(points={{18,37},
                {19.8462,37},{22,37}},
                             color={0,0,0}));
          connect(table3.robotComTable, robotComTerm.robotComRobot) annotation (Line(
                points={{28,37},{28,27.1923},{35,27.1923},{35,19}},
                color={0,0,0}));
          connect(table3.tableComNext, endTable.tableComPrev) annotation (Line(points={{38,37},
                {39.8462,37},{42,37}},                                         color=
                  {0,0,0}));
        ...
        model MainExtended
          ...
          Modelica_StateGraph2.Blocks.Interactive.TrigButton trigButton1
            annotation (Placement(transformation(
                ...
                rotation=180)));
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.StartTable
          startTable                   annotation (Placement(transformation(extent={{-80,54},
                  {-60,74}},          rotation=0)));
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.EndTable
          endTable                 annotation (Placement(transformation(extent={{60,-26},
                  {80,-6}},         rotation=0)));
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TableHorizontal
          table
            annotation (Placement(transformation(extent={{-60,54},{-40,74}},rotation=
                    0)));
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TableHorizontal
          table2
            annotation (Placement(transformation(extent={{-20,54},{0,74}},rotation=0)));
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TurnTableRight
          turnTableRight1                       annotation (Placement(transformation(
                  extent={{0,54},{20,74}},rotation=0)));
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TableVertical
          tableDown
            annotation (Placement(transformation(extent={{0,34},{20,54}}, rotation=0)));
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TableVertical
          tableDown1
            annotation (Placement(transformation(extent={{0,14},{20,34}},   rotation=
                    0)));
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TurnTableLeft
          turnTableLeft2                      annotation (Placement(transformation(
                  extent={{0,-6},{20,14}},   rotation=0)));
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TurnTableRight
          turnTableRight                       annotation (Placement(transformation(
                  extent={{20,-6},{40,14}},   rotation=0)));
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TurnTableLeft
          turnTableLeft                      annotation (Placement(transformation(
                  extent={{20,-26},{40,-6}},  rotation=0)));
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TableHorizontal
          table1
            annotation (Placement(transformation(extent={{40,-26},{60,-6}},  rotation=
                   0)));
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Utilities.RobotHorizontal
          robot
            annotation (Placement(transformation(extent={{-20,54},{0,80}},rotation=0)));
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Utilities.RobotTermHorizontal
          robotTermHorizontal
            annotation (Placement(transformation(extent={{-60,54},{-40,80}},rotation=
                    0)));
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Utilities.RobotTermVertical
          robotTermVertical
            annotation (Placement(transformation(extent={{0,14},{26,34}},   rotation=
                    0)));
          ...
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Utilities.RobotHorizontal
          robot1
            annotation (Placement(transformation(extent={{40,-26},{60,0}},   rotation=
                   0)));
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Tables.TableHorizontal
          tableHorizontal                        annotation (Placement(transformation(
                  extent={{-40,54},{-20,74}},rotation=0)));
          Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Utilities.RobotHorizontal
          robotHorizontal
            annotation (Placement(transformation(extent={{-40,54},{-20,80}},rotation=
                    0)));
        equation
          connect(startTable.tableComNext, table.tableComPrev) annotation (Line(
                points={{-62,57},{-60,57},{-58,57}},                           color=
                  {0,0,0}));
          connect(table.robotComTable, robotTermHorizontal.robotComRobot)
            annotation (Line(points={{-52,57},{-51.1538,57},{-48,57}},
                                   color={0,0,0}));
          connect(tableDown.robotComTable, robotDown.robotComRobot) annotation (Line(
                points={{3,46},{3,45.1923},{3,42}},
                color={0,0,0}));
          connect(tableDown1.robotComTable, robotTermVertical.robotComRobot)
            annotation (Line(points={{3,26},{3,25.1923},{3,22}},
                                        color={0,0,0}));
          connect(turnTableLeft2.tableComNext, turnTableRight.tableComPrev)
            annotation (Line(points={{18,-3},{21.2,-3}},
                color={0,0,0}));
          connect(turnTableLeft.tableComNext, table1.tableComPrev) annotation (Line(
                points={{38,-23},{42,-23}},                              color={0,0,0}));
          connect(table1.robotComTable, robot1.robotComRobot) annotation (Line(points={{48,-23},
                {48.8462,-23},{52,-23}},
                color={0,0,0}));
          connect(table1.tableComNext, endTable.tableComPrev) annotation (Line(points={{58,-23},
                {59.8462,-23},{62,-23}},
                color={0,0,0}));
          connect(tableHorizontal.robotComTable, robotHorizontal.robotComRobot) annotation (Line(
                points={{-32,57},{-31.1538,57},{-28,57}},
                color={0,0,0}));
          connect(table2.robotComTable, robot.robotComRobot) annotation (Line(points={{-12,57},
                {-11.1539,57},{-8,57}},
                color={0,0,0}));
          connect(tableHorizontal.tableComPrev, table.tableComNext) annotation (Line(
              points={{-38,57},{-40,57},{-42,57}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(table2.tableComPrev, tableHorizontal.tableComNext) annotation (Line(
              points={{-18,57},{-20,57},{-22,57}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(turnTableRight1.tableComPrev, table2.tableComNext) annotation (Line(
              points={{1.2,57},{1.2,57},{-2,57}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(tableDown.tableComPrev, turnTableRight1.tableComNext) annotation (
              Line(
              points={{3,52},{3,55.2}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(tableDown.tableComNext, tableDown1.tableComPrev) annotation (Line(
              points={{3,36},{3,36},{3,32}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(tableDown1.tableComNext, turnTableLeft2.tableComPrev) annotation (
              Line(
        ...
        package Internal
          ...
          package Tables
            ...
            "Generates cars that are sent on to the production line"
              ...
              tableComNext                                         annotation (Placement(
                    transformation(extent={{76,-73},{84,-65}}, rotation=0),
              ...
              Modelica.Blocks.Interfaces.BooleanOutput next_transport
                annotation (Placement(transformation(
                    ...
                    rotation=180)));
            equation
              connect(next_ready, tableComNext.Ready) annotation (Line(points={{-111,0},
                    {55.9385,0},{80,0},{80,-22.8428},{80,-69}},
                                        color={255,0,255},
                smooth=Smooth.Bezier));
              connect(next_idle, tableComNext.Idle) annotation (Line(points={{-110,
                    -40},{45.8594,-40},{80,-40},{80,-69}},
                                          color={255,0,255},
                smooth=Smooth.Bezier));
              connect(next_transport, tableComNext.Transport) annotation (Line(points={{-110,
                    -80},{63.4863,-80},{80,-80},{80,-69}},
                                                     color={255,0,255},
                smooth=Smooth.Bezier));
            end StartTable;
            ...
            model EndTable "Ends the line"
              ...
              tableComPrev                                         annotation (Placement(
                    transformation(extent={{-84,-73},{-76,-65}}, rotation=0),
              ...
              Modelica.Blocks.Logical.Not Not
                annotation (Placement(transformation(
                    ...
                    rotation=180)));
            equation
              connect(prev_ready, tableComPrev.Ready) annotation (Line(points={{110,0},
                    {-54.3945,0},{-80,0},{-80,-25.6729},{-80,-69}},
                                          color={255,0,255},
                smooth=Smooth.Bezier));
              connect(prev_idle, tableComPrev.Idle) annotation (Line(points={{112,-40},
                    {-50.375,-40},{-80,-40},{-80,-69}},
                                            color={255,0,255},
                smooth=Smooth.Bezier));
              connect(Not.y, tableComPrev.Transport)  annotation (Line(points={{-21,-80},
                    {-66.8633,-80},{-80,-80},{-80,-69}},
                                            color={255,0,255},
                smooth=Smooth.Bezier));
              connect(Not.u, prev_transport)  annotation (Line(points={{2,-80},{112,-80}},
                    color={255,0,255},
                smooth=Smooth.Bezier));
            end EndTable;
            ...
            "Vertical table operating in southbound direction"
              ...
              annotation (Diagram(coordinateSystem(preserveAspectRatio=true,  extent={{-100,
                ...
                Icon(coordinateSystem(preserveAspectRatio=true,  extent={{-100,
                  ...
                  Rectangle(
                    ...
                    fillPattern=FillPattern.Solid),
                  Polygon(
                    points=DynamicSelect([zeros(4),zeros(4)], newPoints),
                    lineColor={0,0,0},
                    fillColor={255,0,0},
                    fillPattern=FillPattern.Solid)}));
              Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.RobotComTable
              robotComTable                          annotation (Placement(transformation(
                      extent={{-96,-6},{-84,6}}), iconTransformation(extent={{-74,16},{-66,
                        24}})));
              Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.TableComNext
              tableComNext                         annotation (Placement(transformation(
                      extent={{-96,-86},{-84,-74}}), iconTransformation(extent={{-74,-84},{
                        -66,-76}})));
              Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.TableComPrev
              tableComPrev
              ...
              Modelica.Blocks.Sources.BooleanExpression Prev_Transport(y=InTransport.active)
                annotation (Placement(transformation(extent={{-34,60},{-60,80}})));
              Modelica.Blocks.Sources.BooleanExpression OutTransport_active(y=OutTransport.active)
                annotation (Placement(transformation(extent={{-34,40},{-60,60}})));
            ...
            equation
              ...
              connect(or1.u1, OutTransport_active.y) annotation (Line(
                  points={{-79.2,30},{-84,30},{-84,40},{-84,50},{-71.3643,50},{-61.3,50}},
                  color={255,0,255},
                  smooth=Smooth.Bezier));
              connect(or1.u2, Prev_Transport.y) annotation (Line(
                  points={{-79.2,25.2},{-90,25.2},{-90,39.5414},{-90,60},{-90,70},{-76.3787,
                      70},{-61.3,70}},
                  color={255,0,255},
                  smooth=Smooth.Bezier));
              connect(Robot_StartWork.y, robotComTable.StartWork) annotation (Line(
            ...
            "Table which turns the track direction southbound"
              ...
              annotation (
                ...
                Icon(coordinateSystem(preserveAspectRatio=true,  extent={{-100,
                  ...
                  Rectangle(
                    ...
                    fillPattern=FillPattern.Solid),
                  Rectangle(
                    extent=DynamicSelect({{-46,100},{46,-100}}, rectangle1),
                    lineColor={95,95,95},
                    fillColor={135,135,135},
                    fillPattern=FillPattern.Solid),
                  Rectangle(
                    extent=DynamicSelect({{-100,46},{100,-46}}, rectangle2),
                    lineColor={95,95,95},
                    fillColor={135,135,135},
                    fillPattern=FillPattern.Solid),
                  Polygon(
              ...
              Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.TableComPrev
              tableComPrev                                         annotation (Placement(
                    transformation(extent={{-96,-66},{-84,-54}},     rotation=0),
                    iconTransformation(extent={{-92,-74},{-84,-66}})));
              Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.TableComNext
              tableComNext                                         annotation (Placement(
                    transformation(extent={{-66,-96},{-54,-84}},     rotation=0),
                    iconTransformation(extent={{-74,-92},{-66,-84}})));
              Modelica.Blocks.Sources.BooleanExpression Prev_Idle(y=Empty.active)
                annotation (Placement(transformation(
                    origin={-47,-54},
                    extent={{-27,-14},{5,6}},
            ...
            equation
              ...
              connect(Next_Ready.y, tableComNext.Ready)         annotation (Line(points={{-37.6,
                      -80},{-49.6,-80},{-49.6,-90},{-60,-90}},
                                                  color={255,0,255},
                  smooth=Smooth.Bezier));
              connect(Prev_Idle.y, tableComPrev.Idle)          annotation (Line(points={{-53.6,
                      -50},{-61.2395,-50},{-70,-50},{-70,-55},{-70,-60},{-79.0527,-60},{-88,
                      -60},{-90,-60}},                         color={255,0,255},
                  smooth=Smooth.Bezier));
              connect(Prev_Transport.y, tableComPrev.Transport)     annotation (Line(
                    points={{-53.6,-30},{-90,-30},{-90,-60}},
                                                        color={255,0,255},
                  smooth=Smooth.Bezier));
              connect(or1.u1, Prev_Transport.y)     annotation (Line(points={{-80,
                    20.8},{-80,20.8},{-80,-5.88984},{-80,-30},{-53.6,-30}},
                                                              color={255,0,255},
                  smooth=Smooth.Bezier));
              connect(OutTransport_Active.y, or1.u2)
                                                    annotation (Line(points={{-57.8,
                    -10},{-75.2,-10},{-75.2,8.40781},{-75.2,20.8}},
                                                                  color={255,0,255},
                  smooth=Smooth.Bezier));
            connect(indicatorLamp.activePort, or1.y) annotation (Line(
            ...
            "Horizontal table operating in eastbound direction"
              ...
              annotation (
                ...
                Icon(coordinateSystem(preserveAspectRatio=true,  extent={{-100,
                  ...
                  Polygon(
                    ...
                    fillPattern=FillPattern.Solid),
                  Ellipse(
                    extent=DynamicSelect({{0,0},{0,0}}, newBlinkPoints),
                    lineColor={255,0,0},
                    fillColor={255,17,0},
                    fillPattern=FillPattern.Solid)}),
                DymolaStoredErrors);
              ...
              Modelica.Blocks.Sources.BooleanExpression OutTransport_active(y=OutTransport.active)
                annotation (Placement(transformation(extent={{-100,-10},{-76,10}})));
              Modelica.Blocks.Sources.BooleanExpression Prev_Transport(y=InTransport.active)
                annotation (Placement(transformation(extent={{-100,-30},{-76,-10}})));
              Modelica.Blocks.Sources.BooleanExpression Prev_Idle(y=Empty.active)
              ...
              Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.TableComPrev
              tableComPrev
                annotation (Placement(transformation(extent={{-86,-96},{-74,-84}}),
                    iconTransformation(extent={{-84,-74},{-76,-66}})));
              Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.RobotComTable
              robotComTable
              ...
              Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.TableComNext
              tableComNext
                annotation (Placement(transformation(extent={{74,-96},{86,-84}}),
                    iconTransformation(extent={{76,-74},{84,-66}})));
            equation
              carInPosition = pos >= -0.5 and pos < 0.5;
              ...
              connect(Robot_StartWork.y, robotComTable.StartWork) annotation (Line(
                  ...
                  smooth=Smooth.Bezier));
              connect(Prev_Idle.y, tableComPrev.Idle) annotation (Line(
                  points={{-74.8,-40},{-72,-40},{-72,-52.9433},{-72,-76.8164},{-72,-90},{
                      -80,-90}},
                  color={255,0,255},
                  smooth=Smooth.Bezier));
              connect(Prev_Transport.y, tableComPrev.Transport) annotation (Line(
                  points={{-74.8,-20},{-62,-20},{-62,-33.3984},{-62,-74.0808},{-62,-90},{
                      -80,-90}},
                  color={255,0,255},
                  smooth=Smooth.Bezier));
              connect(or1.u1, OutTransport_active.y) annotation (Line(
            ...
            "Table which turns the track direction eastbound"
              ...
              annotation (
                ...
                Icon(coordinateSystem(preserveAspectRatio=true,  extent={{-100,
                  ...
                  Rectangle(
                    ...
                    fillPattern=FillPattern.Solid),
                  Rectangle(
                    extent=DynamicSelect({{-100,46},{100,-46}}, rectangle1),
                    lineColor={95,95,95},
                    fillColor={135,135,135},
                    fillPattern=FillPattern.Solid),
                  Rectangle(
                    extent=DynamicSelect({{-46,100},{46,-100}}, rectangle2),
                    lineColor={95,95,95},
                    fillColor={135,135,135},
                    fillPattern=FillPattern.Solid),
                  Polygon(
              ...
              Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.TableComPrev
              tableComPrev                                         annotation (Placement(
                    transformation(extent={{-86,86},{-74,74}},     rotation=0),
                    iconTransformation(extent={{-82,82},{-74,74}})));
              Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.TableComNext
              tableComNext                                         annotation (Placement(
                    transformation(extent={{86,-74},{74,-86}},     rotation=0),
                    iconTransformation(extent={{84,-66},{76,-74}})));
              Modelica.Blocks.Sources.BooleanExpression Prev_Idle(y=Empty.active)
                annotation (Placement(transformation(
                    origin={-19,94},
                    extent={{1,-6},{27,14}},
          ...
          package Utilities
            model RobotComTerm "Connects to table RobotCom, used for testing"
              ...
              robotComRobot                                          annotation (Placement(
              ...
              Modelica.Blocks.Interfaces.BooleanOutput y
                annotation (Placement(transformation(
                    ...
                    rotation=270)));
            equation
              connect(y, robotComRobot.StartWork) annotation (Line(points={{30,-110},{
                      30,-50},{50,-50}}, color={255,0,255},
                smooth=Smooth.Bezier));
              connect(u, robotComRobot.WorkDone) annotation (Line(points={{70,-111},{70,
                      -50},{50,-50}}, color={255,0,255},
                smooth=Smooth.Bezier));
            end RobotComTerm;
            ...
            "Robot that can be connected to a horizontal table"
              ...
              annotation (
                ...
                Icon(coordinateSystem(
                  ...
                  Ellipse(
                    ...
                    fillPattern=FillPattern.Solid),
                  Polygon(
                    points=DynamicSelect({{-58,94},{-28,92},{6,148},{-4,156},{-58,
                        94}}, PolOnePoints),
                    lineColor={0,0,0},
                    fillColor={255,128,0},
                    fillPattern=FillPattern.Solid),
                  Polygon(
                    points=DynamicSelect({{-4,154},{4,146},{38,148},{36,152},{-4,
                        154}}, PolTwoPoints),
                    lineColor={0,0,0},
                    fillColor={255,128,0},
                    fillPattern=FillPattern.Solid),
                  Polygon(
                    points=DynamicSelect({{30,150},{38,150},{38,132},{36,134},{
                        36,138},{30,150}}, PolThreePoints),
                    lineColor={0,0,0},
                    fillColor={0,0,0},
                    fillPattern=FillPattern.Solid),
                  Ellipse(
              ...
              Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.RobotComRobot
              robotComRobot                                          annotation (Placement(
                    transformation(extent={{-4,-84},{4,-76}}, rotation=0),
                    iconTransformation(extent={{16,-74},{24,-66}})));

              Modelica.Blocks.Sources.BooleanExpression Work_Done(y=WorkDone.active)
                annotation (Placement(transformation(extent={{-98,-94},{-40,-66}}, rotation=
                       0)));
            equation
              ...
              if robotComRobot.StartWork then
                ...
                PolThreePoints = [30,150; 38,150; 38,132; 36,134; 36,138; 30,150];
              end if;
              connect(Work_Done.y, robotComRobot.WorkDone)          annotation (Line(points={{-37.1,
                      -80},{-18,-80},{0,-80}},                  color={255,0,
                    255},
                smooth=Smooth.Bezier));
            end RobotHorizontal;

            model RobotVertical
            "Robot than can be connected with vertical table"
              extends
              Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Interfaces.Robot;
              annotation (
                Diagram(coordinateSystem(
                ...
                Icon(coordinateSystem(
                  ...
                  Ellipse(
                    ...
                    fillPattern=FillPattern.Solid),
                  Polygon(
                    points=DynamicSelect({{94,58},{92,28},{148,-6},{156,4},{94,
                        58}}, PolOnePoints),
                    lineColor={0,0,0},
                    fillColor={255,128,0},
                    fillPattern=FillPattern.Solid),
                  Polygon(
                    points=DynamicSelect({{154,4},{146,-4},{148,-38},{152,-36},
                        {154,4}}, PolTwoPoints),
                    lineColor={0,0,0},
                    fillColor={255,128,0},
                    fillPattern=FillPattern.Solid),
                  Polygon(
                    points=DynamicSelect({{150,-30},{150,-38},{132,-38},{134,-36},
                        {138,-36},{150,-30}}, PolThreePoints),
                    lineColor={0,0,0},
                    fillColor={0,0,0},
                    fillPattern=FillPattern.Solid),
                  Ellipse(
              ...
              Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.RobotComRobot
              robotComRobot                                          annotation (Placement(
                    transformation(extent={{-73,-4},{-81,4}}, rotation=0),
                    iconTransformation(extent={{-66,-24},{-74,-16}})));
            ...
            equation
              if robotComRobot.StartWork then
                ...
                PolThreePoints = [24,-18; 24,-26; 6,-26; 8,-24; 12,-24; 24,-18];
              else
                PolOnePoints = [94,58; 92,28; 148,-6; 156,4; 94,58];
                PolTwoPoints = [154,4; 146,-4; 148,-38; 152,-36; 154,4];
                PolThreePoints = [150,-30; 150,-38; 132,-38; 134,-36; 138,-36; 150,-30];
              end if;
            ...
            "Terminator for horizontal tables used solely for transportation"
              ...
              Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.RobotComRobot
              robotComRobot                                          annotation (Placement(
                    transformation(extent={{-4,-80},{4,-72}}, rotation=0),
                    iconTransformation(extent={{16,-74},{24,-66}})));

              Modelica.Blocks.Sources.BooleanExpression Start_Work(y=robotComRobot.StartWork)
                annotation (Placement(transformation(extent={{-98,-74},{-40,-46}},
                      rotation=0)));
            equation
              connect(Start_Work.y, robotComRobot.WorkDone)         annotation (Line(
                    points={{-37.1,-60},{-30.0028,-60},{-20,-60},{-20,-68.1719},
                    {-20,-76},{-11.8359,-76},{0,-76}},                color={255,0,
                    255},
                smooth=Smooth.Bezier));
            ...
            "Terminator for vertical tables used solely for transportation"
              ...
              Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.RobotComRobot
              robotComRobot                                          annotation (Placement(
                    transformation(extent={{-81,4},{-73,-4}}, rotation=0),
            ...
            equation
              connect(Start_Work.y, robotComRobot.WorkDone)         annotation (Line(
                    points={{-22.9,5.68298e-015},{-48.45,5.68298e-015},{-48.45,
                    0},{-77,0}},
                           color={255,0,255},
                smooth=Smooth.Bezier));
          ...
          package Interfaces
            partial model Table "Table Logic"
              ...
              Modelica.Blocks.Sources.BooleanExpression Prev_Ready
                annotation (Placement(transformation(extent={{10,52},{40,72}},  rotation=0)));
              Modelica.Blocks.Sources.BooleanExpression Next_Idle
                annotation (Placement(transformation(extent={{10,-44},{40,-24}},   rotation=
                       0)));
              ...
              Modelica.Blocks.Sources.BooleanExpression Robot_WorkDone
                annotation (Placement(transformation(extent={{-10,-10},{20,10}}, rotation=0)));
              Modelica.Blocks.Sources.BooleanExpression CarInPosition
                annotation (Placement(transformation(extent={{10,24},{40,44}}, rotation=0)));
              Modelica.Blocks.Logical.Not Not  annotation (Placement(transformation(extent={{44,-66},
                        {52,-58}},             rotation=0)));
              Modelica_StateGraph2.Step InTransport(           nIn=1, nOut=1)
                annotation (Placement(transformation(extent={{56,44},{64,52}})));
              Modelica_StateGraph2.Transition limit_switch(
              ...
              Modelica_StateGraph2.Transition robot_work_done(
                  use_conditionPort=true, loopCheck=false)
                annotation (Placement(transformation(extent={{36,-4},{44,4}})));
              Modelica_StateGraph2.Step Waiting(           nIn=1, nOut=2)
              ...
              Modelica_StateGraph2.Step OutTransport(           nIn=1, nOut=1)
                annotation (Placement(transformation(extent={{56,-52},{64,-44}})));
              Modelica_StateGraph2.Transition next_transport(
                  use_conditionPort=true)
            ...
            equation
              ...
              connect(Empty.outPort[2], prev_ready.inPort) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.Bezier));
              connect(limit_switch.inPort,InTransport. outPort[1]) annotation (Line(
              ...
              connect(limit_switch.outPort,Occupied. inPort[2]) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.Bezier));
              connect(CarInPosition.y, limit_switch.conditionPort) annotation (Line(
                  points={{41.5,34},{41.5,34},{55,34}},
                  color={255,0,255},
                  smooth=Smooth.Bezier));
              connect(robot_work_done.inPort,Occupied. outPort[1]) annotation (Line(
                  points={{40,4},{40,9.4}},
                  color={0,0,0},
                  smooth=Smooth.Bezier));
              connect(Waiting.inPort[1], robot_work_done.outPort) annotation (Line(
                  points={{40,-10},{40,-5}},
                  color={0,0,0},
                  smooth=Smooth.Bezier));
              connect(OutTransport.inPort[1], next_idle.outPort) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.Bezier));
              connect(next_transport.inPort,OutTransport. outPort[1]) annotation (Line(
              ...
              connect(Waiting.outPort[2], next_idle.inPort) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.Bezier));
              connect(Robot_WorkDone.y, robot_work_done.conditionPort) annotation (Line(
              ...
              connect(next_transport.outPort, Empty.inPort[1]) annotation (Line(
                  points={{60,-67},{60,-74},{44.3713,-74},{-4.53125,-74},{-20,-74},{-20,
                      -56.6602},{-20,18},{-20,78.3418},{-20,92},{-1.85059,92},{32.4974,92},
                      {39,92},{39,84}},
                  color={0,0,0},
                  smooth=Smooth.Bezier));
              connect(next_remove.outPort, Empty.inPort[2]) annotation (Line(
                  points={{0,-53},{0,-74},{-9.53125,-74},{-20,-74},{-20,-52.6133},{-20,76},
                      {-20,92},{-4,92},{30,92},{41,90},{41,84}},
                  color={0,0,0},
                  smooth=Smooth.Bezier));
            end Table;
            ...
            partial model TurnTable "Table which turns the track"
              ...
              Modelica.Blocks.Sources.BooleanExpression Next_Idle(y=tableComNext.Idle)
                annotation (Placement(transformation(extent={{10,-58},{40,-38}},   rotation=
                       0)));
              Modelica.Blocks.Sources.BooleanExpression Next_Transport(y=tableComNext.Transport)
                annotation (Placement(transformation(extent={{8,-98},{38,-78}},
                      rotation=0)));
              Modelica.Blocks.Sources.BooleanExpression Robot_WorkDone(y=true)
                annotation (Placement(transformation(extent={{-10,-22},{20,-2}}, rotation=0)));
              Modelica.Blocks.Sources.BooleanExpression CarInPosition(y=carInPosition)
                annotation (Placement(transformation(extent={{10,12},{40,32}}, rotation=0)));
              Modelica.Blocks.Logical.Not Not  annotation (Placement(transformation(extent={{44,-92},
                        {52,-84}},             rotation=0)));
              Modelica_StateGraph2.Step InTransport(           nIn=1, nOut=1)
            ...
            equation
              ...
              connect(Waiting.outPort[2], next_idle.inPort) annotation (Line(
                  ...
                  smooth=Smooth.Bezier));
              connect(next_transport.outPort, Empty.inPort[1]) annotation (Line(
                  points={{60,-93},{60,-98},{50.9766,-98},{-32.4726,-98},{-60,-98},{-60,
                      -68},{-60,80.4922},{-60,98},{-40,98},{30.8994,98},{39,98},{39,86}},
                  color={0,0,0},
                  smooth=Smooth.Bezier));
              connect(next_remove.outPort, Empty.inPort[2]) annotation (Line(
            ...
            "Robot that can be connected to a horizontal table"
              ...
              parameter Real[18,2] weldPoints = {{16,24},{30,16},{30.2285,22.627},{32,74},{32,25.1191},{32,16},
                          {40,22},{32,16},{34.5977,13.7734},{46,4},{33.2656,13.5508},{30,16},
                          {26,2},{30,16},{18,12},{30,16},{30,16},{16,24}};
              Modelica_StateGraph2.Examples.Applications.ProductionLine.Internal.Connectors.RobotComRobot
              robotComRobot;
              ...
              Modelica_StateGraph2.Step Working(           nIn=1, nOut=1)
                annotation (Placement(transformation(extent={{16,6},{24,14}})));
              Modelica_StateGraph2.Transition finished_work(
                  delayedTransition=true, waitTime=3)
                annotation (Placement(transformation(extent={{16,-14},{24,-6}})));
              Modelica_StateGraph2.Step WorkDone(           nIn=1, nOut=1)
                annotation (Placement(transformation(extent={{16,-34},{24,-26}})));
              Modelica_StateGraph2.Transition return_to_wait
            ...
            equation
              ...
              connect(finished_work.outPort, WorkDone.inPort[1]) annotation (Line(
                  ...
                  color={0,0,0},
                  smooth=Smooth.Bezier));
              connect(WorkDone.outPort[1], return_to_wait.inPort) annotation (Line(
      ...
      package HarelsWristWatch
        ...
        model WristWatch
            ...
            extends Modelica.Icons.Example;
        import Modelica_StateGraph2_Tests;
          annotation (Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-400,
              ...
              Text(
                ...
                lineColor={0,0,0},
                lineThickness=0.5,
                textString="Alarm 1 on"),
              Text(
                extent={{-308,220},{-308,200}},
                lineColor={0,0,0},
                lineThickness=0.5,
                textString="Alarm 2 on"),
              Text(
...
<p>To run model interactively, enable Realtime in the Experiment setup and set load result interval to 0.01.</p>
          ...
          Out out(
            ...
            annotation (Placement(transformation(extent={{-170,-140},{-74,-100}})));
          Stopwatch stopwatch(
          ...
          Modelica_StateGraph2.Transition two_min_in_out(           delayedTransition=true,
              waitTime=120)                            annotation (Placement(
                transformation(
                extent={{-4,-4},{4,4}},
                rotation=180,
                origin={-186,-80})));
      ...
      public
          ...
          Modelica.Blocks.Logical.Not not1
            annotation (Placement(transformation(extent={{-258,-32},{-250,-24}})));
          ...
          Modelica.Blocks.Logical.Edge edge5
            annotation (Placement(transformation(extent={{-120,-82},{-128,-74}})));
      ...
      public
          Modelica.Blocks.Logical.Edge edge6 annotation (Placement(transformation(
                ...
                rotation=180,
                origin={-36,100})));
          Utilities.AlarmTrigger alarmTrigger annotation (Placement(transformation(
                extent={{-10,10},{10,-10}},
                rotation=90,
                origin={24,-154})));
      ...
      protected
          Modelica_StateGraph2.Examples.Applications.HarelsWristWatch.Utilities.SignalBus
          top_level_bus_node1
            annotation (Placement(transformation(extent={{-190,140},{-170,160}}),
                iconTransformation(extent={{-82,110},{-62,130}})));
      public
          Modelica_StateGraph2.Blocks.MathBoolean.Or or1(
                                        nu=2) annotation (Placement(transformation(
                extent={{-4,-4},{4,4}},
                rotation=180,
                origin={-208,150})));
      public
        ...
        equation
          ...
          connect(out.outPort[1], out_a.inPort) annotation (Line(
              points={{-121.76,-140.7},{-121.76,-152.35},{-135.255,-152.35},{
                  -173.516,-152.35},{-186,-152.35},{-186,-146}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          ...
          connect(thirty_secs_in_alarms_beep.inPort, alarms_beep.suspend[2])
            annotation (Line(
              ...
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(any_button_pressed.outPort, displays.resume[1]) annotation (Line(
          ...
          connect(displays.inPort[1], main.entry[1]) annotation (Line(
              ...
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(main.entry[2], alarm1_status_disabled.inPort[1]) annotation (Line(
          ...
          connect(alarm1_enabled_d.outPort, alarm1_status_disabled.inPort[2])
            annotation (Line(
              ...
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(alarm2_status_disabled.inPort[1], main.entry[3]) annotation (Line(
              points={{79,-86},{79,-70},{92,-70},{110,-70},{110,-45.956},{110,
                14.031},{110,36},{81.367,36},{8.8965,36},{-4.66667,36},{
                -4.66667,47}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          ...
          connect(main.entry[6], power_ok.inPort[1]) annotation (Line(
              points={{23.3333,47},{25,47},{25,42},{39.3192,42},{247.165,42},{
                272,42},{272,20},{272,-57.4453},{272,-72},{260.012,-72},{250,
                -72},{250,-86}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(stopwatch_a.conditionPort, regular_a.conditionPort) annotation (Line(
              points={{-189,-90},{-155.888,-90},{-148,-90},{-148,-83.7305},{-148,
                  -78},{-155,-78}},
              color={255,0,255},
              smooth=Smooth.Bezier));

          connect(out_a.conditionPort, stopwatch_a.conditionPort) annotation (Line(
          ...
          connect(two_min_in_out.outPort, regular.inPort[1]) annotation (Line(
              points={{-186,-75},{-186,-75},{-186,-68},{-199.975,-68},{-216,-68},
                {-216,-50.6912},{-216,-18.629},{-216,-2},{-192.102,-2},{
                -174.156,-2},{-167.2,-2},{-167.2,-6}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(stopwatch_a.outPort, regular.inPort[2]) annotation (Line(
              points={{-194,-85},{-194,-85},{-194,-81.0352},{-194,-70},{
                -205.156,-70},{-218,-70},{-218,-58.3203},{-218,-18},{-218,0},{
                -198.988,0},{-168.986,0},{-162.4,0},{-162.4,-6}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(choose_alarm.outPort[1], t_hits_t1_p.inPort) annotation (Line(
              points={{-1.33333,-24.6},{-1.33333,-24.6984},{-1.3333,-30},{
                -5.7812,-30},{-12,-30},{-12,-38.75},{-12,-87.8164},{-12,-98},{
                -5.95312,-98},{0,-98},{0,-106}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          ...
          connect(choose_alarm.outPort[2], t_hits_t2_p2.inPort) annotation (Line(
              points={{1.11022e-016,-24.6},{0,-24.6},{0,-26},{0,-32},{-4.5996,
                -32},{-10,-32},{-10,-37.5898},{-10,-58},{0,-58},{0,-66}},
              color={0,0,0},
              smooth=Smooth.Bezier));

          connect(choose_alarm.outPort[3], t_hits_t1.inPort) annotation (Line(
              points={{1.33333,-24.6},{2,-34},{0,-34}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          ...
          connect(battery_removed.outPort, dead.inPort[2]) annotation (Line(
              points={{-320,45},{-320,45},{-320,100},{-320,120},{-297.586,120},{-18,120},
                  {-1,120},{-1,104}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(battery_dies.outPort, dead.inPort[1]) annotation (Line(
              points={{0,-225},{0,-240},{20.5078,-240},{280,-240},{320,-240},{320,-197.962},
                  {320,78.867},{320,120},{280.532,120},{20.626,120},{1,120},{1,104}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          ...
          connect(top_level_bus_node, main_bus_node) annotation (Line(
              points={{-112,90},{-112,90},{190.504,90},{210,90},{210,69.521},{210,0}},
              color={255,204,51},
              thickness=0.5,
              smooth=Smooth.Bezier));
          ...
          connect(alarms_bus_node, main_bus_node) annotation (Line(
              ...
              thickness=0.5,
              smooth=Smooth.Bezier));
          connect(light_off_b_down.conditionPort, main_bus_node.b) annotation (Line(
          ...
          connect(power_ok_battery_weakens.conditionPort, main_bus_node.weaken_battery)
            annotation (Line(
              points={{245,-120},{236.879,-120},{218,-120},{218,-99.73},{218,
                  -22.0937},{218,-16},{212.58,-16},{208,-16},{208,-7.437},{208,0},{
                  210,0}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          ...
          connect(and2.u1, main_bus_node.chime_on) annotation (Line(
              points={{134.8,-6},{144,-6},{144,1.875},{144,8},{152,8},{200,8},{210,
                  8},{210,0}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(regular_time_c.inPort, regular.suspend[1]) annotation (Line(
              points={{-228,-18},{-228,-18},{-228,-12},{-222.238,-12},{-213.603,
                -12},{-208,-12},{-208,-16.4063},{-208,-18},{-209.92,-18}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          ...
          connect(wait_c_up_1.outPort, regular.inPort[3]) annotation (Line(
              points={{-240,-23},{-240,-16.9209},{-240,2},{-220.919,2},{
                -166.819,2},{-157.6,2},{-157.6,-6}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          ...
          connect(not1.u, edge1.u) annotation (Line(
              points={{-258.8,-28},{-272,-28},{-272,-16},{-272,7.99414},{-272,26},{
                  -247.154,26},{-191.992,26},{-184,26},{-184,20},{-184,6},{-197.2,6}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          ...
          connect(and6.u2, and4.u2) annotation (Line(
              points={{61.2,-53.2},{56,-53.2},{56,-58.5979},{56,-107.927},{56,
                  -113.2},{61.2,-113.2}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          ...
          connect(and6.u1, alarms_bus_node.alarm1_on) annotation (Line(
              points={{61.2,-50},{46,-50},{46,-67.9102},{46,-170.804},{46,-190},{60,
                  -190}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(and7.u1, alarms_bus_node.alarm1_off) annotation (Line(
              points={{61.2,-10},{44,-10},{44,-28.6328},{44,-169.199},{44,-190},{60,
                  -190}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          ...
          connect(alarmTrigger.alarm1_enabled, alarm1_status_enabled.activePort)
            annotation (Line(
              points={{33.2857,-165.429},{33.2857,-170},{37.6525,-170},{42.7188,
                -170},{82,-170},{106,-170},{106,-146.127},{106,-51.3281},{106,
                -30},{84.72,-30}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(alarmTrigger.alarm2_enabled, alarm2_status_enabled.activePort)
            annotation (Line(
              points={{26.1429,-165.429},{26.1429,-172},{37.5295,-172},{85.7158,
                -172},{110,-172},{110,-149.4},{110,-130},{84.72,-130}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          ...
          connect(edge7.y, p_or_p1_or_p2.conditionPort) annotation (Line(
              ...
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(alarmTrigger.T_hits_T1, alarms_bus_node.T_hits_T1) annotation (Line(
              points={{29.7143,-165.429},{29.7143,-171},{36.0851,-171},{42,-171},
                {42,-178.96},{42,-190},{60,-190}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(alarmTrigger.T_hits_T2, alarms_bus_node.T_hits_T2) annotation (Line(
          ...
          connect(t_hits_t1.conditionPort, alarmTrigger.P1) annotation (Line(
              points={{5,-38},{31,-38},{31,-63.7046},{31,-143.286},{31.1429,
                -143.286}},
              color={255,0,255},
              smooth=Smooth.Bezier));

          connect(t_hits_t2_p2.conditionPort, alarmTrigger.P2) annotation (Line(
              points={{5,-70},{27,-70},{27,-93.6891},{27,-143.286},{26.8571,
                -143.286}},
              color={255,0,255},
              smooth=Smooth.Bezier));

          connect(t_hits_t1_p.conditionPort, alarmTrigger.P) annotation (Line(
              points={{5,-110},{23,-110},{23,-130.251},{23,-143.286},{22.7143,
                -143.286}},
              color={255,0,255},
              smooth=Smooth.Bezier));

          connect(alarmTrigger.alarms_beep, edge7.u) annotation (Line(
              points={{17,-143.286},{17,-142},{13.2627,-142},{-26,-142},{-26,
                -103.586},{-26,-22.8}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(set_illumination.u[2], light_on.activePort) annotation (Line(
              points={{361.5,30},{361.5,-0.527344},{361.5,-30},{330.936,-30},{244.72,-30}},
              color={255,0,255},
              smooth=Smooth.Bezier));

          connect(stopwatch.activePort, displays_bus_node.stopwatch_mode) annotation (
              Line(
              points={{-241,-120.1},{-250,-120.1},{-250,-130},{-250,-154},{-228.958,-154},
                  {-90.3945,-154},{-68,-154},{-68,-130.326},{-68,-92},{-68,-70},{-90,-70}},
              color={255,0,255},
              smooth=Smooth.Bezier));

          connect(watchController.large_digit1, watchDisplay.large_digit1) annotation (
              Line(
              points={{62,176},{62,176},{109.76,176},{128,176},{128,194}},
              color={255,127,0},
              smooth=Smooth.Bezier));
          connect(watchController.large_digit2, watchDisplay.large_digit2) annotation (
              Line(
              points={{62,170},{62,170},{124.736,170},{148,170},{148,194}},
              color={255,127,0},
              smooth=Smooth.Bezier));
          connect(watchController.large_digit3, watchDisplay.large_digit3) annotation (
              Line(
              points={{62,164},{62,164},{160,164},{190,164},{190,194}},
              color={255,127,0},
              smooth=Smooth.Bezier));
          connect(watchController.large_digit4, watchDisplay.large_digit4) annotation (
              Line(
              points={{62,158},{62,158},{186.756,158},{208,158},{208,174.77},{208,194}},
              color={255,127,0},
              smooth=Smooth.Bezier));
          connect(watchController.small_digit, watchDisplay.small_digit) annotation (
              Line(
              points={{62,152},{62,152},{234,152},{254,152},{254,167.947},{254,194.973},
                  {254,208},{242,208}},
              color={255,127,0},
              smooth=Smooth.Bezier));
          connect(watchController.text_digit, watchDisplay.text_digit) annotation (Line(
              points={{62,146},{62,146},{246,146},{272,146},{272,167.225},{272,205.545},
                  {272,232},{242,232}},
              color={255,127,0},
              smooth=Smooth.Bezier));
          ...
          connect(edge6.y, top_level_bus_node.dead_active) annotation (Line(
              points={{-40.4,100},{-40.4,100},{-92,100},{-108,100},{-108,90},{-112,90}},
              color={255,0,255},
              smooth=Smooth.Bezier));

          connect(watchController.display_node, top_level_bus_node) annotation (Line(
              points={{37.6,140},{33.6,140},{33.6,128},{14.1535,128},{-71.7609,128},{-112,
                  128},{-112,90}},
              color={255,204,51},
              thickness=0.5,
              smooth=Smooth.Bezier));
          connect(alarm1_beeps.activePort, displays_bus_node.alarm1_beeps) annotation (
              Line(
              points={{-4.72,-50},{-4.72,-50},{-74.7595,-50},{-90,-50},{-90,-70}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(alarm2_beeps.activePort, displays_bus_node.alarm2_beeps) annotation (
              Line(
              points={{-4.72,-90},{-16,-90},{-71.7891,-90},{-90,-90},{-90,-70}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(both_beep.activePort, displays_bus_node.both_beep) annotation (Line(
              points={{-4.72,-130},{-54,-130},{-54,-86.3008},{-54,-64},{-76,-64},{-88,-64},
                  {-88,-70},{-90,-70}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          ...
          connect(or2.u[2], top_level_bus_node1.both_beep) annotation (Line(
              ...
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(showValue2.activePort, top_level_bus_node1.chime_on) annotation (Line(
              points={{-229,190},{-210,190},{-180,190},{-180,150}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(alarm2_status_enabled.activePort, alarms_bus_node.alarm2_enabled)
            annotation (Line(
              points={{84.72,-130},{110,-130},{110,-152},{110,-186},{74,-186},{60,-186},
                  {60,-190}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(alarm1_status_enabled.activePort, alarms_bus_node.alarm1_enabled)
            annotation (Line(
              points={{84.72,-30},{106,-30},{106,-52},{106,-151.773},{106,-184},{74,-184},
                  {60,-184},{60,-190}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(showValue.activePort, top_level_bus_node1.alarm1_enabled) annotation (
             Line(
        ...
        model Regular
          ...
          Modelica_StateGraph2.Transition time_c_down(
            ...
            annotation (Placement(transformation(extent={{4,4},{-4,-4}},
                rotation=180,
                origin={0,60})));
          Modelica_StateGraph2.Transition mode_c(
            delayedTransition=false,
            use_conditionPort=true)                                    annotation (
              Placement(transformation(
                extent={{4,-4},{-4,4}},
                rotation=180,
                origin={-12,-40})));
          ...
          Modelica_StateGraph2.Transition second_c(
                                  use_conditionPort=true, loopCheck=false)
            annotation (Placement(transformation(extent={{-124,26},{-116,34}})));
          Modelica_StateGraph2.Transition minute_c(
                                  use_conditionPort=true)
            annotation (Placement(transformation(extent={{-124,-14},{-116,-6}})));
          Modelica_StateGraph2.Transition ten_minutes_c(
                                  use_conditionPort=true)
          ...
          Modelica_StateGraph2.Transition hour_c(
                                  use_conditionPort=true)
            annotation (Placement(transformation(extent={{-84,26},{-76,34}})));
          Modelica_StateGraph2.Transition month_c(
                                  use_conditionPort=true)
            annotation (Placement(transformation(extent={{-84,-12},{-76,-4}})));
          Modelica_StateGraph2.Transition date_c(
                                  use_conditionPort=true)
          ...
          Modelica_StateGraph2.Step date(      nOut=1,
            nIn=1,
            use_activePort=true)
          ...
          Modelica_StateGraph2.Transition OO_b_down(
                                    use_conditionPort=true)
            annotation (Placement(transformation(extent={{110,14},{118,22}})));
          Modelica_StateGraph2.Transition OO_d_down(
                                    use_conditionPort=true)
          ...
          Modelica_StateGraph2.Transition IO_d_down(
                                    use_conditionPort=true)
            annotation (Placement(transformation(extent={{110,-26},{118,-18}})));
          Modelica_StateGraph2.Transition OI_b_down(
                                    use_conditionPort=true)
          ...
          Modelica_StateGraph2.Step date_(           nOut=2, nIn=1,
            use_activePort=true)
          ...
          Modelica_StateGraph2.Transition two_min_in_date(
              delayedTransition=true, waitTime=120)
      ...
      public
          ...
          Modelica_StateGraph2.Blocks.MathInteger.MultiSwitch day_quantity(
            ...
            annotation (Placement(transformation(extent={{-20,-10},{20,10}},
                rotation=0,
                origin={20,10})));
          Modelica_StateGraph2.Blocks.MathInteger.TriggeredAdd day_setting(    use_reset=
               true)
      ...
      public
        ...
        equation
          ...
          connect(date_c.inPort,date. outPort[1]) annotation (Line(
              ...
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(update.entry[1],second. inPort[1])
                                                    annotation (Line(
          ...
          connect(day_c.inPort,day. outPort[1]) annotation (Line(
              ...
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(update.resume[1],perform_increment. outPort)
                                                              annotation (Line(
              points={{-140,-45},{-150,-45},{-150,-7}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(mode.outPort[1],update. exit[1])
                                                  annotation (Line(
              points={{-40,-34.6},{-40,-34.6},{-40,-62},{-68.5156,-62},{-80,-62},{-80,-73}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(two_min_in_update.outPort, time_.inPort[1])
                                               annotation (Line(
              points={{-154,77},{-154,96},{-134.396,96},{-1.18348,96},{18.3333,
                96},{18.3333,82}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(mode_c.outPort,time_. inPort[2]) annotation (Line(
              points={{-12,-35},{-12,-35},{-12,60.4336},{-12,86},{5.5625,86},{19,86},{19,
                  82}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          ...
          connect(ten_minutes_c.outPort,hour. inPort[1]) annotation (Line(
              points={{-120,-55},{-120,-60},{-113.246,-60},{-106,-60},{-92,-60},{-92,-45.9852},
                  {-92,54.6182},{-92,62},{-85.0039,62},{-80,62},{-80,54}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(second.activePort, time_quantity.u[1])
                                                    annotation (Line(
              points={{-115.28,50},{-104,50},{-104,35.0267},{-104,-36.625},{-104,-47.3312},
                  {-104,-67.75},{-86.4297,-67.75},{0,-67.75}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(minute.activePort, time_quantity.u[2])
                                                    annotation (Line(
              points={{-115.28,10},{-106,10},{-106,-1.11504},{-106,-28.774},{-106,-51.4036},
                  {-106,-69},{-88,-69},{0,-69},{0,-69.25}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(ten_minutes.activePort, time_quantity.u[3])
                                                         annotation (Line(
              points={{-115.28,-30},{-108,-30},{-108,-39.9852},{-108,-58.5069},{-108,-70.75},
                  {-92.0742,-70.75},{0,-70.75}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(hour.activePort, time_quantity.u[4])
                                                  annotation (Line(
              points={{-75.28,50},{-58,50},{-58,33.2079},{-58,-51.7461},{-58,-72},{-40.2266,
                  -72},{-30,-72},{0,-72.25}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          ...
          connect(ten_minutes_c.conditionPort, minute_c.conditionPort) annotation (Line(
              points={{-125,-50},{-130,-50},{-130,-43.9063},{-130,-14.8674},{-130,
                  -10},{-125,-10}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(minute_c.conditionPort, second_c.conditionPort) annotation (Line(
              points={{-125,-10},{-130,-10},{-130,-3.55469},{-130,25.8057},{-130,30},
                  {-125,30}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          ...
          connect(hour_c.conditionPort, day_c.conditionPort) annotation (Line(
              points={{-85,30},{-90,30},{-90,34.834},{-90,40},{-82.7813,40},{
                  -56.6267,40},{-50,40},{-50,34.5215},{-50,30},{-45,30}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          ...
          connect(not2.y, beep_b_up.conditionPort) annotation (Line(
              points={{156,-51.6},{156,-42},{156,-36},{151.088,-36},{146,-36},{146,
                  -31.42},{146,-25.5547},{146,-22},{149,-22}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(not2.u, OI_b_down.conditionPort) annotation (Line(
              points={{156,-60.8},{156,-64},{152,-64},{144,-64},{144,-56.0898},{144,
                  -36.5312},{144,-28},{135.992,-28},{128.157,-28},{124,-28},{124,
                  -25.0059},{124,-22},{129,-22}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          ...
          connect(OO_b_down.conditionPort, not4.u) annotation (Line(
              points={{109,18},{100,18},{100,32.4297},{100,52},{100,60},{92.5156,60},{84,
                  60},{84,48.8}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          ...
          connect(OO_d_down.conditionPort, not5.u) annotation (Line(
              points={{131,18},{126,18},{126,21.4297},{126,26},{131.25,26},{138,26},
                  {138,33.9314},{138,48.3125},{138,54},{142.188,54},{146,54},{146,
                  50.8}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(T2.inPort, update.suspend[1]) annotation (Line(
              points={{-144,74},{-144,74},{-144,68},{-144,54.3333},{-143,
                54.3333}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          ...
          connect(T2.outPort, time_.inPort[5]) annotation (Line(
              points={{-144,83},{-144,94},{-131.994,94},{-10.3665,94},{21,94},{21,82}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          ...
          connect(pre1.y, ten_minutes_c.conditionPort) annotation (Line(
              ...
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(time_setting.u, time_quantity.y)
                                      annotation (Line(
              points={{46.2,-70},{41,-70}},
              color={255,127,0},
              smooth=Smooth.Bezier));
          connect(time_setting.trigger, perform_increment.firePort)
                                                            annotation (Line(
              points={{50.4,-77.2},{50,-80},{43.8444,-80},{-3.875,-80},{-10,-80},{-10,-78},
                  {-16.5078,-78},{-99.6906,-78},{-108,-78},{-108,-70.4941},{-108,-64},{-116.818,
                  -64},{-123.176,-64},{-136,-64},{-136,-50.9789},{-136,-12.7168},{-136,-2},
                  {-145.8,-2}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(time_setting.y, signalBus.update_time)
                                                 annotation (Line(
              points={{61.2,-70},{61.2,-70},{71.6648,-70},{84,-70},{84,-82},{92,-82},{144,
                  -82},{144,-80},{140,-80}},
              color={255,127,0},
              smooth=Smooth.Bezier), Text(
              string="%second",
          ...
          connect(second.activePort, show_time.u[1]) annotation (Line(
              points={{-115.28,50},{-100,50},{-100,30.3125},{-100,-80.7181},{
                -100,-90.76},{-92,-90.76}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          ...
          connect(ten_minutes.activePort, show_time.u[3]) annotation (Line(
              points={{-115.28,-30},{-100,-30},{-100,-43.8752},{-100,-82.6229},{
                  -100,-93},{-92,-93}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          ...
          connect(month.activePort, show_date.u[1]) annotation (Line(
              points={{-75.28,10},{-60,10},{-60,-6.5},{-60,-65.5815},{-60,-86},
                {-16,-86},{-16,-86.1333}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          ...
          connect(year.activePort, signalBus.show_year) annotation (Line(
              points={{-35.28,10},{-28,10},{-28,0.25},{-28,-72.1863},{-28,-94},{
                  -4.70313,-94},{126.293,-94},{140,-94},{140,-80}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(mode.activePort, signalBus.mode_active) annotation (Line(
              points={{-35.28,-30},{-30,-30},{-30,-37.3621},{-30,-78.0176},{-30,-96},{-10.7811,
                  -96},{128.711,-96},{140,-96},{140,-80}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          ...
          connect(date_d.outPort, time_.inPort[6]) annotation (Line(
              ...
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(date_setting.u, date_quantity.y)
                                      annotation (Line(
              points={{46.2,-50},{46.2,-50},{41,-50}},
              color={255,127,0},
              smooth=Smooth.Bezier));
          connect(mode_setting.u, mode_quantity.y)
                                      annotation (Line(
              points={{46.2,-30},{46.2,-30},{41,-30}},
              color={255,127,0},
              smooth=Smooth.Bezier));
          connect(year_setting.u, year_quantity.y)
                                      annotation (Line(
              points={{46.2,-10},{46.2,-10},{41,-10}},
              color={255,127,0},
              smooth=Smooth.Bezier));
          connect(time_setting.trigger, date_setting.trigger) annotation (Line(
              points={{50.4,-77.2},{50.4,-78},{43,-78},{43,-60},{50.4,-60},{50.4,-57.2}},
              color={255,0,255},
              smooth=Smooth.Bezier));

          connect(date_setting.trigger, mode_setting.trigger) annotation (Line(
              points={{50.4,-57.2},{50.4,-60},{43,-60},{43,-40},{50.4,-40},{50.4,-37.2}},
              color={255,0,255},
              smooth=Smooth.Bezier));

          connect(mode_setting.trigger, year_setting.trigger) annotation (Line(
              points={{50.4,-37.2},{50.4,-40},{43,-40},{43,-20},{50.4,-20},{50.4,-17.2}},
              color={255,0,255},
              smooth=Smooth.Bezier));

          connect(time_c_down.conditionPort, day_c.conditionPort) annotation (Line(
              points={{-5,60},{-5,60},{-10,60},{-17.7344,60},{-39.6649,60},{-50,60},{-50,
                  50.4841},{-50,38.584},{-50,30},{-45,30}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(year_setting.trigger, day_setting.trigger) annotation (Line(
              points={{50.4,-17.2},{50.4,-20},{43,-20},{43,0},{50.4,0},{50.4,
                2.8}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          ...
          connect(year_quantity.u[1], year.activePort) annotation (Line(
              points={{0,-10},{-18.3203,-10},{-28,-10},{-28,0},{-28,10},{-35.28,10}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          ...
          connect(bus_node3, signalBus) annotation (Line(
              points={{74,-20},{74,-20},{74,-30},{74,-64.2344},{74,-86},{93.541,-86},{132,
                  -86},{132,-80},{140,-80}},
              color={255,204,51},
              smooth=Smooth.Bezier,
              thickness=0.5));
          ...
          connect(time_c_down.outPort, update.inPort[1]) annotation (Line(
              points={{-6.12323e-016,55},{0,50},{-6,50},{-6,56.4453},{-6,74},{
                -6,90},{-20.9065,90},{-65.4688,90},{-80,90},{-80,80}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(time_.outPort[2], exit[1]) annotation (Line(
              points={{20,73.4},{20,73.4},{20,60.3422},{20,46},{8.06641,46},{-6,46},{-6,
                  27.6523},{-6,-64.2581},{-6,-76},{0,-76},{0,-105}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          ...
          connect(pre2.y, perform_increment.conditionPort) annotation (Line(
              points={{-152,-67.6},{-152,-67.6},{-152,-10.8125},{-152,-6},{-156,-6},{-158,
                  -6},{-158,-3.77734},{-158,-2},{-155,-2}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          ...
          connect(time_setting.reset, bus_node3.dead_active) annotation (Line(
              points={{57.6,-77.2},{57.6,-84},{64.7438,-84},{72,-84},{72,
                -74.3125},{72,-20},{74,-20}},
              color={255,0,255},
              smooth=Smooth.Bezier));

          connect(date_setting.reset, time_setting.reset) annotation (Line(
              points={{57.6,-57.2},{57.6,-60},{66,-60},{66,-80},{57.6,-80},{57.6,-77.2}},
              color={255,0,255},
              smooth=Smooth.Bezier));

          connect(date_setting.reset, mode_setting.reset) annotation (Line(
              points={{57.6,-57.2},{57.6,-60},{66,-60},{66,-40},{57.6,-40},{57.6,-37.2}},
              color={255,0,255},
              smooth=Smooth.Bezier));

          connect(mode_setting.reset, year_setting.reset) annotation (Line(
              points={{57.6,-37.2},{57.6,-40},{66,-40},{66,-20},{57.6,-20},{57.6,-17.2}},
              color={255,0,255},
              smooth=Smooth.Bezier));

          connect(year_setting.reset, day_setting.reset) annotation (Line(
              points={{57.6,-17.2},{57.6,-20},{66,-20},{66,0},{57.6,0},{57.6,
                2.8}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          ...
          connect(edge2.y, date_d.conditionPort) annotation (Line(
              points={{73.6,90},{73.6,90},{8.4125,90},{-16,90},{-16,64.2036},{-16,54.543},
                  {-16,32},{12,32}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(edge2.y, edge1.u) annotation (Line(
              points={{73.6,90},{70,90},{70,84.8828},{70,57.8691},{70,50},{60.8,50}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(month.activePort, date_quantity.u[1]) annotation (Line(
              points={{-75.28,10},{-60,10},{-60,-6},{-60,-35.6484},{-60,-50},{-46.5234,-50},
                  {0,-50},{0,-48.5}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(date.activePort, date_quantity.u[2]) annotation (Line(
              points={{-75.28,-26},{-62,-26},{-62,-37.2808},{-62,-51.5},{-48.4375,-51.5},
                  {0,-51.5}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(date_.activePort, bus_node3.date_active) annotation (Line(
              points={{34.72,46},{41.599,46},{50,46},{50,40},{59.3516,40},{78,40},{78,23.5938},
                  {78,-20},{74,-20}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(mode.activePort, show_time.u[5]) annotation (Line(
              points={{-35.28,-30},{-30,-30},{-30,-37.7363},{-30,-64},{-51.752,
                -64},{-80.3251,-64},{-104,-64},{-104,-78.0031},{-104,-95.24},{
                -92,-95.24}},
              color={255,0,255},
              smooth=Smooth.Bezier));
        end Regular;
        ...
        model Out
          ...
          Modelica_StateGraph2.Transition chime_off_d(
                      use_conditionPort=true,
            use_firePort=false)
          ...
          Modelica_StateGraph2.Transition alarm1_off_d(
            use_conditionPort=true,
            use_firePort=false)
          ...
          Modelica_StateGraph2.Transition update1_hour_c(
                                    use_conditionPort=true)
          ...
          Modelica_StateGraph2.Transition update1_ten_min_c(
                                    use_conditionPort=true)
          ...
          Modelica_StateGraph2.Transition update1_b(
                      use_conditionPort=true, loopCheck=false)
            annotation (Placement(transformation(extent={{126,22},{134,30}})));
          Modelica_StateGraph2.Transition update1_c(
                      use_conditionPort=true, loopCheck=false)
          ...
          Modelica_StateGraph2.Transition alarm2_off_d(
            use_conditionPort=true,
            use_firePort=false)
          ...
          Modelica_StateGraph2.Step update2_hour(
            ...
            use_activePort=true)
            annotation (Placement(transformation(extent={{-24,46},{-16,54}})));
          Modelica_StateGraph2.Transition update2_hour_c(
                                    use_conditionPort=true)
          ...
          Modelica_StateGraph2.Step update2_ten_min(
            ...
            use_activePort=true)
            annotation (Placement(transformation(extent={{-24,6},{-16,14}})));
          Modelica_StateGraph2.Transition update2_ten_min_c(
                                    use_conditionPort=true)
            annotation (Placement(transformation(extent={{-24,-14},{-16,-6}})));
      ...
      protected
          ...
          update2_bus_node
            annotation (Placement(transformation(extent={{-2,-44},{18,-24}}),
                iconTransformation(extent={{-10,-4},{10,16}})));
      public
      ...
      public
          Modelica.Blocks.Logical.Edge edge9
            annotation (Placement(transformation(extent={{4,-4},{-4,4}},
                rotation=270,
                origin={-74,18})));
      protected
      ...
      protected
          ...
          alarm1_bus_node
            annotation (Placement(transformation(extent={{100,-10},{120,10}})));
      public
          Modelica.Blocks.Logical.Edge edge10
            annotation (Placement(transformation(extent={{-4,-4},{4,4}},
                rotation=270,
                origin={112,-14})));
      ...
      protected
          Modelica_StateGraph2.Examples.Applications.HarelsWristWatch.Utilities.SignalBus
          alarm1_bus_node1
            annotation (Placement(transformation(extent={{190,-44},{210,-24}}),
                iconTransformation(extent={{190,-20},{210,0}})));
      public
          Modelica.Blocks.Logical.Edge edge1
            annotation (Placement(transformation(extent={{-4,-4},{4,4}},
                rotation=180,
                origin={168,-50})));
          Modelica_StateGraph2.Blocks.MathInteger.MultiSwitch quantity2(    expr={60*60,
                60*10,60}, nu=3,
            use_pre_as_default=false)
            annotation (Placement(transformation(extent={{-12,-6},{12,6}},
                rotation=270,
                origin={14,28})));
          Modelica_StateGraph2.Blocks.MathInteger.TriggeredAdd alarm2_setting
                ...
                rotation=270,
                origin={9,-3})));
          Modelica_StateGraph2.Blocks.MathInteger.MultiSwitch quantity1(    expr={60*60,
                60*10,60}, nu=3,
            use_pre_as_default=false)
            annotation (Placement(transformation(extent={{-12,-6},{12,6}},
                rotation=270,
        ...
        equation
          ...
          connect(update1.entry[1],update1_hour. inPort[1]) annotation (Line(
              ...
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(update1_hour.outPort[1],update1_hour_c. inPort) annotation (Line(
              points={{170,45.4},{170,34}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(update1_hour_c.outPort,update1_ten_min. inPort[1]) annotation (Line(
              points={{170,25},{170,14}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(update1_ten_min_c.outPort,update1_min. inPort[1]) annotation (Line(
              points={{170,-15},{170,-15},{170,-26}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(update1_ten_min.outPort[1],update1_ten_min_c. inPort) annotation (
              Line(
          ...
          connect(update1_b.outPort,alarm1. resume[1]) annotation (Line(
              points={{130,21},{130,21},{130,4},{130,-23.371},{130,-48},{
                105.244,-48},{79.35,-48},{52,-48},{52,-31.604},{52,-12.2917},{
                60,-12.2917}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          ...
          connect(update2.entry[1],update2_hour. inPort[1]) annotation (Line(
              ...
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(update2_hour.outPort[1],update2_hour_c. inPort) annotation (Line(
              points={{-20,45.4},{-20,34}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(update2_hour_c.outPort,update2_ten_min. inPort[1]) annotation (Line(
              points={{-20,25},{-20,14}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(update2_min.outPort[1], update2.exit[1])  annotation (Line(
              ...
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(update2_ten_min_c.outPort, update2_min.inPort[1])  annotation (Line(
              points={{-20,-15},{-20,-15},{-20,-26}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(update2_ten_min.outPort[1],update2_ten_min_c. inPort) annotation (
              Line(
              points={{-20,5.4},{-20,5.4},{-20,-6}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          ...
          connect(update2_b.outPort,alarm2. resume[1]) annotation (Line(
              points={{-58,23},{-58,23},{-58,4},{-58,-23.371},{-58,-48},{
                -82.756,-48},{-108.65,-48},{-136,-48},{-136,-31.604},{-136,
                -12.2917},{-128,-12.2917}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(alarm2.resume[2],update2_c. outPort) annotation (Line(
              points={{-128,-18.125},{-130,-18.125},{-130,-18},{-140,-18},{-140,
                -32.47},{-140,-57.724},{-140,-80},{-115.752,-80},{-26.627,-80},
                {-10,-80},{-10,-73}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          ...
          connect(alarm1_a.outPort,alarm2. resume[3]) annotation (Line(
              points={{42,-39},{42,-39},{42,-68},{42,-84},{30,-84},{-109.906,
                -84},{-146,-84},{-146,-54.265},{-146,-36.4429},{-146,-24},{-138,
                -24},{-138,-23.9583},{-128,-23.9583}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          ...
          connect(chime_off_d.conditionPort, chime_on_d.conditionPort) annotation (Line(
              points={{-205,20},{-212,20},{-212,10.4297},{-212,-9.98554},{-212,-20},
                  {-205,-20}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(alarm2_off_d.conditionPort, alarm2_on_d.conditionPort) annotation (
              Line(
          ...
          connect(alarm1_off_d.conditionPort, alarm1_on_d.conditionPort) annotation (
              Line(
          ...
          connect(update1_hour_c.conditionPort, update1_ten_min_c.conditionPort)
            annotation (Line(
              points={{165,30},{160,30},{160,23.4766},{160,-3.10199},{160,-10},{165,
                  -10}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(update2_ten_min_c.conditionPort, update2_c.conditionPort) annotation (
             Line(
          ...
          connect(alarm1_c.conditionPort, alarm2_c.conditionPort) annotation (Line(
              points={{55,60},{60,60},{64,60},{64,65.4277},{64,82.209},{64,92},{
                  54.9247,92},{-114.012,92},{-126,92},{-126,82.0313},{-126,70},{
                  -126,60},{-133,60}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          ...
          connect(edge6.y, alarm2_on_d.conditionPort) annotation (Line(
              ...
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(alarm2_off.activePort, alarm2_bus_node.alarm2_off) annotation (Line(
              points={{-103.28,40},{-82,40},{-82,20.4219},{-82,0},{-78,0}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(alarm2_on.activePort, alarm2_bus_node.alarm2_on) annotation (Line(
          ...
          connect(update2_b.conditionPort, edge9.y) annotation (Line(
              ...
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(chime_off.activePort, chime_bus_node.chime_off) annotation (Line(
          ...
          connect(signalBus, chime_bus_node) annotation (Line(
              points={{-220,80},{-234,80},{-234,64.0078},{-234,-77.1162},{-234,-98},
                  {-213.625,-98},{-190.577,-98},{-170,-98},{-170,-77.2324},{-170,0}},
              color={255,128,0},
              smooth=Smooth.Bezier));
          ...
          connect(update2_bus_node, alarm2_bus_node) annotation (Line(
              ...
              color={255,128,0},
              smooth=Smooth.Bezier));
          connect(alarm1_on.activePort, alarm1_bus_node.alarm1_on) annotation (Line(
          ...
          connect(update2_bus_node, alarm1_bus_node) annotation (Line(
              points={{8,-34},{8,-71.3301},{8,-80},{16,-80},{24,-80},{24,-88},{24,
                  -98},{43.8594,-98},{84.6999,-98},{106,-98},{106,-77.232},{106,
                  -8.0702},{106,0},{110,0}},
              color={255,128,0},
              smooth=Smooth.Bezier));
          ...
          connect(update2_hour.activePort, quantity2.u[1]) annotation (Line(
              points={{-15.28,50},{-15.28,50},{-8.23785,50},{9,50},{9,34},{9.2,
                34}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          ...
          connect(update2_ten_min.activePort, quantity2.u[2]) annotation (Line(
              points={{-15.28,10},{-12,10},{-12,14.5645},{-12,39.184},{-12,48},
                {-3.01563,48},{8,48},{8,34}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(update2_min.activePort, quantity2.u[3]) annotation (Line(
              points={{-15.28,-30},{-10,-30},{-10,-21.6616},{-10,34.1992},{-10,
                46},{-1.40313,46},{6.8,46},{6.8,34}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(alarm2_setting.u, quantity2.y)
                                               annotation (Line(
              points={{8,3.2},{8,4.75},{8,4.75},{8,6.3},{8,9.4},{8,9.4}},
              color={255,127,0},
              smooth=Smooth.Bezier));
          connect(alarm2_setting.trigger, update2_d.firePort)
                                                            annotation (Line(
          ...
          connect(edge1.y, update1_ten_min_c.conditionPort) annotation (Line(
              points={{163.6,-50},{160,-50},{160,-45.0195},{160,-16},{160,-10},{165,
                  -10}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(update1_c.conditionPort, edge1.y) annotation (Line(
              ...
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(alarm1_setting.u, quantity1.y)
                                               annotation (Line(
          ...
          connect(update1_min.activePort, quantity1.u[3]) annotation (Line(
              ...
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(update1_d.firePort, alarm1_setting.trigger)
                                                            annotation (Line(
              points={{146.2,18},{156,18},{156,9.09961},{156,-1.6},{195.2,-1.6}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(alarm1_setting.y, alarm1_bus_node1.T1)
                                                       annotation (Line(
              points={{200,-8.8},{200,-8.8},{200,-34}},
              color={255,127,0},
              smooth=Smooth.Bezier));
          connect(alarm2_setting.y, update2_bus_node.T2)
                                                       annotation (Line(
          ...
          connect(or2.u[1], alarm1.activePort) annotation (Line(
              points={{224.1,-14},{224,-14},{224,74},{224,96},{204.01,96},{146.754,
                  96},{124,96},{124,70.0633},{124,16.7188},{124,10},{121.25,10}},
              color={255,0,255},
              smooth=Smooth.Bezier));
        ...
        model Stopwatch
          extends Modelica_StateGraph2.PartialParallel(           nEntry=1, use_outPort=false);
          Parallel displayrun(
            nIn=1,
            nEntry=2,
            use_outPort=true,
          ...
          Modelica_StateGraph2.Transition reg_d(
            use_conditionPort=true,
            delayedTransition=false)
          ...
          Modelica_StateGraph2.Step zero(      nOut=1, nIn=2,
            use_activePort=true)
            annotation (Placement(transformation(extent={{-4,46},{4,54}})));
          Modelica_StateGraph2.Transition zero_b(
            use_conditionPort=true,
            delayedTransition=false)
            annotation (Placement(transformation(extent={{-4,26},{4,34}})));
          Modelica_StateGraph2.Transition on_b(
            use_conditionPort=true,
            delayedTransition=false)
          ...
          Modelica_StateGraph2.Transition displayrun_d(           use_conditionPort=
                true, delayedTransition=false,
            loopCheck=false)
      ...
      public
          ...
          Modelica.Blocks.Sources.SampleTrigger time_increment_trigger
        ...
        Blocks.MathInteger.MultiSwitch select_display_of_time_or_lap_time(nu=3,
            expr={stopwatch_clock.y,stopwatch_lap.y,0})
                                annotation (Placement(transformation(
              extent={{-29,-10},{29,10}},
              rotation=90,
              origin={-58,17})));
        ...
        equation
          ...
          connect(lap_d.inPort,lap. outPort[1]) annotation (Line(
              points={{-10,-24},{-10,-36.365},{-10,-50},{-20,-50},{-29,-50},{
                -29,-44.6}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          connect(lap_d.outPort,reg. inPort[2]) annotation (Line(
              points={{-10,-15},{-10,-2.5},{-10,10},{-17.985,10},{-29,10},{-29,
                4}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          ...
          connect(displayrun_d.outPort, zero.inPort[2]) annotation (Line(
              points={{0,-91},{0,-98},{11.9148,-98},{50.209,-98},{82,-98},{82,
                -67.8758},{82,64.3535},{82,92},{56.8948,92},{12.707,92},{1,92},
                {1,54}},
              color={0,0,0},
              smooth=Smooth.Bezier));
          ...
          connect(lap_d.conditionPort, reg_d.conditionPort) annotation (Line(
              points={{-15,-20},{-20,-20},{-20,-26},{-20,-32},{-26.9334,-32},{
                -35.8125,-32},{-42,-32},{-42,-26.6191},{-42,-20},{-34,-20}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(displayrun_d.conditionPort, reg_d.conditionPort) annotation (Line(
              points={{-5,-86},{-24.5117,-86},{-42,-86},{-42,-66.7227},{-42,-26},
                {-42,-20},{-34,-20}},
              color={255,0,255},
              smooth=Smooth.Bezier));
          connect(edge1.u, signalBus.b) annotation (Line(
              points={{-32.8,30},{-40,30},{-40,38.5449},{-40,59.9607},{-40,80},
                {-60,80},{-80,80}},
              color={255,0,255},
              smooth=Smooth.Bezier), Text(
              string="%second",
          ...
          connect(edge2.u, signalBus.d) annotation (Line(
              ...
              index=1,
              extent={{6,3},{6,3}}));
          connect(displayrun.activePort, signalBus.show_stopwatch) annotation (Line(
        ...
        connect(unit_second.y, stopwatch_clock.u)    annotation (Line(
              ...
              color={255,127,0},
              smooth=Smooth.Bezier));
        connect(time_increment_trigger.y, increment_time.u[1])
                                              annotation (Line(
              points={{85.4,62},{80,62},{80,62.1},{66,62.1}},
              color={255,0,255},
              smooth=Smooth.Bezier));
        connect(on.activePort, increment_time.u[2])
                                            annotation (Line(
              points={{34.72,0},{63.0676,0},{74,0},{74,9.4629},{74,34},{74,
                46.8836},{74,57.9},{66,57.9}},
              color={255,0,255},
              smooth=Smooth.Bezier));
        connect(increment_time.y, stopwatch_clock.trigger)
                                                annotation (Line(
              points={{52.8,60},{41.6,60},{41.6,76.8}},
              color={255,0,255},
              smooth=Smooth.Bezier));
        connect(zero.activePort, stopwatch_clock.reset)
                                                       annotation (Line(
              points={{4.72,50},{10,50},{10,56.8906},{10,74},{27.3809,74},{32,
                74},{34.4,74},{34.4,76.8}},
              color={255,0,255},
              smooth=Smooth.Bezier));
        connect(freeze_time.u[1], on.activePort)
                                          annotation (Line(
        ...
        connect(stopwatch_lap.trigger, freeze_time.y)
                                               annotation (Line(
        ...
        connect(off.outPort[1], displayrun.exit[2]) annotation (Line(
            points={{29,-44.6},{28,-44.6},{28,-60},{10.959,-60},{3,-60},{3,
                -67.975}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        connect(off.outPort[2], off_b.inPort) annotation (Line(
            points={{31,-44.6},{31,-44.6},{31,-45},{31,-50},{38.3291,-50},{50,
                -50},{50,-36.2129},{50,-24}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        ...
        connect(lap.activePort, stopwatch_lap.reset) annotation (Line(
            points={{-33.72,-40},{-40,-40},{-40,-46.4258},{-40,-54},{-31.4453,
                -54},{3.5535,-54},{18.4,-54},{18.4,-39.7625},{18.4,54.8}},
            color={255,0,255},
            smooth=Smooth.Bezier));
        ...
        package Utilities
          ...
          model WatchDisplay
            ...
            annotation (Diagram(coordinateSystem(preserveAspectRatio=true,  extent={{-620,
                    -220},{620,220}}),   graphics), Icon(coordinateSystem(
                    preserveAspectRatio=true,  extent={{-620,-220},{620,220}}),
                graphics={
                Rectangle(
                ...
                Text(
                  ...
                  fillColor={127,255,255},
                  fillPattern=FillPattern.Solid,
                  textString=DynamicSelect("0", if small_digit > 0 then
                      realString(
                                small_digit,
                                1,
                                integer(precision)) else "")),
                Rectangle(
                ...
                Text(
                  ...
                  fillColor={127,255,255},
                  fillPattern=FillPattern.Solid,
                  textString=if text_digit == 1 then "Mo" else if text_digit
                       == 2 then "Tu" else if text_digit == 3 then "We" else
                      if text_digit == 4 then "Th" else if text_digit == 5
                       then "Fr" else if text_digit == 6 then "Sa" else if
                      text_digit == 7 then "Su" else if text_digit == 8 then
                      "AM" else if text_digit == 9 then "PM" else if text_digit
                       == 10 then "Ch" else if text_digit == 11 then "SW" else
                      " ")}),
              Documentation(info="<html>
...
<li>Illumination level at the top. Range 0-2. Signals are decoded as: 0 - dark, 1 - normal, 2 - bright.</li>
            ...
            Modelica.Blocks.Interfaces.IntegerInput large_digit1    annotation (Placement(
                  transformation(
                  extent={{-20,-20},{20,20}},
                  rotation=90,
                  origin={-500,-240})));
            ...
            Modelica.Blocks.Interfaces.IntegerInput large_digit2    annotation (Placement(
                  transformation(
                  extent={{-20,-20},{20,20}},
                  rotation=90,
                  origin={-300,-240})));
            Modelica.Blocks.Interfaces.IntegerInput large_digit3    annotation (Placement(
                  transformation(
                  extent={{-20,-20},{20,20}},
                  rotation=90,
                  origin={120,-240})));
            Modelica.Blocks.Interfaces.IntegerInput large_digit4    annotation (Placement(
                  transformation(
                  extent={{-20,-20},{20,20}},
                  rotation=90,
                  origin={300,-240})));
          ...
          model Time
            ...
            annotation (Icon(coordinateSystem(
                ...
                Ellipse(
                  ...
                  fillColor={255,255,255},
                  fillPattern=FillPattern.Solid),
                Line(points={{-14,-4},{16,58}}, color={0,0,0}),
                Line(points={{-14,-4},{20,-28}}, color={0,0,0})}),
                Diagram(coordinateSystem(
                  preserveAspectRatio=true,
                  extent={{-100,-100},{100,100}},
                  initialScale=0.1), graphics),
...
<p>Outputs a time integer signal depending on what mode the watch is currently in. As all four time signals, current time, time setting, alarm1 setting and alarm2 setting should be decoded in the exact same fashion, the output of Time is handled the same in DisplayDecoder. This model also contains the actual clock that makes one tick every second. when a user sets a new time, the discrete state in TriggeredAdd will be reset and the output will re-set to that value and continue ticking.</p>
            ...
            SignalBus signalBus annotation (Placement(transformation(extent={{-98,-14},
                      {-58,26}}),
                             iconTransformation(extent={{-26,-124},{14,-84}})));
        ...
        protected
            SignalBus bus_node  annotation (Placement(transformation(extent={{6,-74},{26,-54}}),
                             iconTransformation(extent={{-26,-124},{14,-84}})));
        public
            ...
            Modelica_StateGraph2.Blocks.MathBoolean.Or or1(    nu=2) annotation (Placement(
                  transformation(
                  extent={{-6,-6},{6,6}},
                  rotation=90,
                  origin={-30,60})));
        public
            Modelica.Blocks.Sources.BooleanExpression T_hits_T1(y=abs(mod(clock_time, 3600
                  *24) - alarm1_time) == 0)
              annotation (Placement(transformation(extent={{-100,-80},{-20,-60}})));
        public
        ...
        public
            Modelica.Blocks.Sources.BooleanExpression T_IS_WHOLE_HOUR(y=mod(
                clock_time, 3600) == 0)
              annotation (Placement(transformation(extent={{22,-11},{-28,9}},
                rotation=0,
                origin={68,-79})));
          equation
            ...
            connect(clock_time, clock.y) annotation (Line(
                points={{12,26},{-12,26},{-12,47.1465},{-12,71.8508},{-12,80},{-26.8,80}},
                color={255,127,0},
                smooth=Smooth.Bezier));
            ...
            connect(time_to_display.u[1], bus_node.time_active) annotation (Line(
                points={{52,2.25},{52,2},{36,2},{36,-15.8535},{36,-43.7352},{36,-64},{16,-64}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            connect(time_to_display.u[2], bus_node.show_time) annotation (Line(
                points={{52,0.75},{41,0.75},{41,-13.7302},{41,-43.7252},{41,-64},{16,-64}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            connect(time_to_display.u[3], bus_node.in_alarm1) annotation (Line(
                points={{52,-0.75},{44,-1},{44,-19.9492},{44,-40.641},{44,-64},{16,-64}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            connect(time_to_display.u[4], bus_node.in_alarm2) annotation (Line(
                points={{52,-2.25},{52,-2},{50,-2},{50,-13.0127},{50,-39.6663},{50,-65},{16,
                    -65},{16,-64}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            connect(bus_node, signalBus) annotation (Line(
                points={{16,-64},{16,-50},{-1.53198,-50},{-59.75,-50},{-80,-50},{-80,-27.1406},
                    {-80,6},{-78,6}},
                color={255,255,0},
                smooth=Smooth.Bezier));
            ...
            connect(update_time, clock.set) annotation (Line(
                points={{12,6},{36,6},{36,28.1165},{36,75.2578},{36,96},{14.2875,96},{-19.3578,
                    96},{-32.32,96},{-32.32,85.88}},
                color={255,127,0},
                smooth=Smooth.Bezier));
            ...
            connect(or1.u[2], signalBus.dead_active) annotation (Line(
                points={{-27.9,54},{-27.9,50},{-20,50},{-20,41.3047},{-20,8},{-72,8},
                    {-72,6},{-78,6}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            connect(clock_time, bus_node.main_time) annotation (Line(
                points={{12,26},{30,26},{30,12.5527},{30,-47.53},{30,-60},{20,-60},{20,-64},
                    {16,-64}},
                color={255,127,0},
                smooth=Smooth.Bezier));
          ...
          block DisplayDecoder
            ...
            annotation (Icon(coordinateSystem(preserveAspectRatio=true, extent={{-160,
                    -160},{160,160}}), graphics={
                Rectangle(
                  extent={{-160,160},{160,-160}},
                  lineColor={95,95,95},
                ...
                Text(
                  extent={{-2,6},{-2,-72}},
                  lineColor={95,95,95},
                  textString="Decoder")}),            Diagram(coordinateSystem(
...
<p>Decodes a number of integer signals (input at the bottom) into six digits to be displayed on a LED display according to definition in the WatchDisplay. Depending on the selected mode, the signals are masked in order to show the chosen entity correctly.</p>
            ...
            "Raw input signal"                                           annotation (
                Placement(transformation(extent={{-20,-20},{20,20}},
                  ...
                  rotation=90,
                  origin={-150,-180})));
            Modelica.Blocks.Interfaces.IntegerOutput large_digit_1 annotation (Placement(
                  transformation(extent={{100,70},{120,90}}), iconTransformation(extent={{160,110},
                      {180,130}})));
            Modelica.Blocks.Interfaces.IntegerOutput large_digit_2 annotation (Placement(
                  transformation(extent={{100,40},{120,60}}), iconTransformation(extent={{160,70},
                      {180,90}})));
            Modelica.Blocks.Interfaces.IntegerOutput large_digit_3 annotation (Placement(
                  transformation(extent={{100,10},{120,30}}), iconTransformation(extent={{160,30},
                      {180,50}})));
            Modelica.Blocks.Interfaces.IntegerOutput large_digit_4 annotation (Placement(
                  transformation(extent={{100,-20},{120,0}}), iconTransformation(extent={{160,-10},
                      {180,10}})));
            Modelica.Blocks.Interfaces.IntegerOutput small_digit annotation (Placement(
                  transformation(extent={{100,-50},{120,-30}}), iconTransformation(extent={{160,-50},
                      {180,-30}})));
            Modelica.Blocks.Interfaces.IntegerOutput text_digit annotation (Placement(
                  transformation(extent={{100,-80},{120,-60}}), iconTransformation(extent={{160,-90},
                      {180,-70}})));
            ...
            Modelica.Blocks.Interfaces.BooleanInput time_mode
            "Raw input signal"
              annotation (Placement(transformation(extent={{-140,60},{-100,100}}),
                  iconTransformation(extent={{-200,120},{-160,160}})));
            Modelica.Blocks.Interfaces.BooleanInput date_mode
            "Raw input signal"
              annotation (Placement(transformation(extent={{-140,0},{-100,40}}),
                  iconTransformation(extent={{-200,60},{-160,100}})));
            Modelica.Blocks.Interfaces.BooleanInput year_mode
            "Raw input signal"
            ...
            Modelica.Blocks.Interfaces.IntegerInput day_signal
            "Raw input signal"
          ...
          equation
            ...
            connect(not1.u, booleanExpression.y) annotation (Line(
                points={{-58,64},{-64.4063,64},{-74,64},{-74,71.1504},{-74,78},{
                    -63.9765,78},{-39.3242,78},{-30,78},{-30,83.2539},{-30,88},{-37,
                    88}},
                color={255,0,255},
                smooth=Smooth.Bezier));
          end DisplayDecoder;
          ...
          block AlarmTrigger
            ...
            annotation (
              Icon(coordinateSystem(preserveAspectRatio=true, extent={{-140,
...
<p>Both alarms will beep when time becomes equal to T1 and P is true.</p>
            ...
            Modelica.Blocks.Interfaces.BooleanInput T_hits_T1 annotation (Placement(
                  transformation(extent={{-140,34},{-100,74}}), iconTransformation(
                    extent={{-180,60},{-140,100}})));
            Modelica.Blocks.Interfaces.BooleanInput T_hits_T2 annotation (Placement(
          ...
          equation
            ...
            connect(alarm2_enabled, and2.u[1]) annotation (Line(
                points={{-120,30},{-42.0547,30},{-32,30},{-32,36.1304},{-32,
                  43.5},{-25.6016,43.5},{46,43.5},{46,44.6667}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            connect(not2.u, alarm1_enabled) annotation (Line(
                points={{-20,20},{-20,20},{-40.8301,20},{-70,20},{-70,50},{-70,80},{-94,
                    80},{-120,80}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            ...
            connect(alarm1_enabled, and1.u[1]) annotation (Line(
                points={{-120,80},{-120,80},{-76.1523,80},{-70,80},{-70,84},{
                  -64.4102,84},{24,84},{24,84.6667}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            ...
            connect(integerToBoolean.y, or1.u[2]) annotation (Line(
                points={{-33,-60},{-24,-60},{-24,-48.0781},{-24,-4},{-24,8.0518},{-24,
                    47.4633},{-24,56.5},{-20,56.5}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            connect(alarm1_enabled, and3.u[1]) annotation (Line(
                points={{-120,80},{-102,80},{-92.7813,80},{-70,80},{-70,53.6628},{-70,
                    25.5762},{-70,4.66667},{-48.1641,4.66667},{60,4.66667},{60,5.25}},
                color={255,0,255},
                smooth=Smooth.Bezier));

            connect(alarm2_enabled, and3.u[2]) annotation (Line(
                points={{-120,30},{-102,30},{-80,30},{-80,16.1133},{-80,2.22045e-016},
                    {-64.2773,2.22045e-016},{60,2.22045e-016},{60,1.75}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            connect(not3.y, and3.u[3]) annotation (Line(
                points={{23,-60},{38,-60},{38,-41.9626},{38,-22.2285},{38,-1.75},{60,-1.75}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            ...
            connect(or3.u[1], and1.y) annotation (Line(
                points={{66,-55.3333},{62,-55.3333},{62,-48},{62,-38},{76.9414,
                  -38},{96,-38},{96,-18.6406},{96,59.0967},{96,80},{76,80},{46,
                  80}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            connect(or3.u[2], and2.y) annotation (Line(
                points={{66,-60},{60,-60},{60,-48.0703},{60,-36},{76,-36},{94,-36},{94,
                    -15.612},{94,23.8203},{94,40},{68,40}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            connect(or3.u[3], and3.y) annotation (Line(
                points={{66,-64.6667},{58,-64.6667},{58,-48.9076},{58,-34},{78,
                  -34},{92,-34},{92,-8.34375},{92,0},{82,0}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            ...
            connect(T1, sum.u[1]) annotation (Line(
                points={{-120,-30},{-110,-30},{-92,-30},{-92,-41.1021},{-92,-56.5},{-84,
                    -56.5}},
                color={255,127,0},
                smooth=Smooth.Bezier));
            connect(T2, sum.u[2]) annotation (Line(
                points={{-120,-80},{-108,-80},{-92,-80},{-92,-72.2334},{-92,-63.5},{-84,
                    -63.5}},
                color={255,127,0},
                smooth=Smooth.Bezier));
            connect(T_hits_T1, and1.u[3]) annotation (Line(
                points={{-120,54},{-104,54},{-64.2031,54},{-56,54},{-56,46},{
                  -47.2623,46},{-3.67578,46},{20,46},{20,66.6536},{20,75.3333},
                  {24,75.3333}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            ...
            connect(T_hits_T2, and2.u[3]) annotation (Line(
                points={{-120,0},{-96.9688,0},{-88,0},{-88,-6.09766},{-88,-14},
                  {-80.0117,-14},{3.5332,-14},{42,-14},{42,28.2995},{42,35.3333},
                  {46,35.3333}},
                color={255,0,255},
                smooth=Smooth.Bezier));

            connect(T_hits_T1, and3.u[4]) annotation (Line(
                points={{-120,54},{-108,54},{-77.5313,54},{-56,54},{-56,27.5574},{-56,
                    15.0304},{-56,-5.25},{-35.8359,-5.25},{60,-5.25}},
                color={255,0,255},
                smooth=Smooth.Bezier));
          end AlarmTrigger;
...
<p>The watch controller contains the clock functionality, gathering of stopwatch signals, time settings and modes from different parts of the wristwatch that are gathered, grouped together and finally decoded into outputs to the LED display.</p>
        ...
        public
            SignalBus display_node
              annotation (Placement(transformation(extent={{-76,44},{-36,84}}),
                  iconTransformation(extent={{-32,-120},{8,-80}})));
          ...
          equation
            connect(time_mode.u[1],display_node. time_active) annotation (Line(
                points={{-18,19.36},{-44,19.36},{-50,40},{-50,62},{-56,62},{-56,64}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            ...
            connect(displayController.time_mode,time_mode. y) annotation (Line(
                ...
                color={255,0,255},
                smooth=Smooth.Bezier));
            connect(displayController.year_mode,display_node. show_year) annotation (Line(
                points={{31.5,0.5},{31.5,0.5},{-30.1553,0.5},{-60,0.5},{-60,25.3511},{
                    -60,64},{-56,64}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            ...
            connect(date_mode.u[1],display_node. date_active) annotation (Line(
                points={{4.44089e-016,10.1},{4.44089e-016,10.1},{-35.875,10.1},
                  {-56,10.1},{-56,28},{-56,46},{-56,64}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            connect(date_mode.u[2],display_node. show_date) annotation (Line(
                points={{4.44089e-016,5.9},{-30,6},{-58,6},{-58,27.6934},{-58,
                  64},{-56,64}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            connect(displayController.stopwatch_mode, display_node.stopwatch_mode)
              annotation (Line(
                points={{31.5,-7},{-24.9619,-6},{-64,-6},{-64,27.0078},{-64,59},{-56,64}},
                color={255,0,255},
                smooth=Smooth.Bezier));
            connect(Time.signalBus, display_node) annotation (Line(
                ...
                smooth=Smooth.Bezier,
                thickness=0.5));
            connect(displayController.mode_signal, display_node.mode_setting) annotation (
               Line(
                points={{42.75,-24.5},{42.75,-42},{42,-54},{30.0781,-54},{-48.4011,-54},
                    {-70,-54},{-70,-31.875},{-70,46.3043},{-70,64},{-56,64}},
                color={255,127,0},
                smooth=Smooth.Bezier));
            connect(displayController.date_signal, display_node.date_setting) annotation (
               Line(
                points={{50.25,-24.5},{50,-42},{50,-58},{34.3122,-58},{-47.3592,-58},{-76,
                    -58},{-76,-33.3652},{-76,45.3853},{-76,64},{-56,64}},
                color={255,127,0},
                smooth=Smooth.Bezier));

            connect(displayController.year_signal, display_node.year_setting) annotation (
               Line(
                points={{57.75,-24.5},{57.75,-24.5},{57.75,-64},{37.9612,-64},{-53.2983,-64},
                    {-82,-64},{-82,-35.875},{-82,45.0784},{-82,64},{-56,64}},
                color={255,127,0},
                smooth=Smooth.Bezier));
            connect(displayController.stopwatch_signal, display_node.stopwatch_time)
              annotation (Line(
                points={{65.25,-24.5},{65.25,-24.5},{65.25,-70},{31.5417,-70},{0,-70},{-54.2266,
                    -70},{-88,-70},{-88,-41.8652},{-88,36.2931},{-88,64},{-56,64}},
                color={255,127,0},
                smooth=Smooth.Bezier));
            connect(displayController.day_signal, display_node.day_setting) annotation (
                Line(
                points={{72.75,-24.5},{72.75,-24.5},{72.75,-76},{34.946,-76},{-66,-76},{-94,
                    -76},{-94,-50.0234},{-94,32.3763},{-94,64},{-56,64}},
                color={255,127,0},
                smooth=Smooth.Bezier));
            connect(displayController.large_digit_1, large_digit1) annotation (Line(
                points={{75.25,13},{80,13},{80,20.8909},{80,59.9785},{80,80},{110,80}},
                color={255,127,0},
                smooth=Smooth.Bezier));
            connect(displayController.large_digit_2, large_digit2) annotation (Line(
                points={{75.25,8},{82,8},{82,17.2655},{82,29.3691},{82,50},{110,50}},
                color={255,127,0},
                smooth=Smooth.Bezier));
            connect(displayController.large_digit_3, large_digit3) annotation (Line(
                points={{75.25,3},{84,3},{84,11.8154},{84,20},{94.5371,20},{110,20}},
                color={255,127,0},
                smooth=Smooth.Bezier));
            connect(displayController.large_digit_4, large_digit4) annotation (Line(
                points={{75.25,-2},{84,-2},{84,-10},{92.0996,-10},{110,-10}},
                color={255,127,0},
                smooth=Smooth.Bezier));
            connect(displayController.small_digit, small_digit) annotation (Line(
                points={{75.25,-7},{82,-7},{82,-16},{82,-25.1406},{82,-40},{96.0547,-40},{
                    110,-40}},
                color={255,127,0},
                smooth=Smooth.Bezier));
            connect(displayController.text_digit, text_digit) annotation (Line(
                points={{75.25,-12},{80,-12},{80,-20.2695},{80,-52.0795},{80,-70},{96.3477,
                    -70},{110,-70}},
                color={255,127,0},
                smooth=Smooth.Bezier));
            connect(time_mode.u[5], display_node.in_chime) annotation (Line(
      ...
      "Example with two processes sharing two resources ending up in a deadlock situation after 5 seconds"
        ...
        annotation (uses(Modelica_StateGraph2(version="0.8"), Modelica(version="3.0.1")),
                                                             Diagram(coordinateSystem(
                preserveAspectRatio=true, extent={{-100,-100},{100,100}}),
            graphics={
            Text(
              extent={{-74,94},{-74,82}},
              lineColor={0,0,0},
              textString="Process 1"),
            Text(
              extent={{76,94},{76,82}},
              lineColor={0,0,0},
              textString="Process 2"),
            Text(
              extent={{0,80},{0,68}},
              lineColor={0,0,0},
              textString="Resource 1"),
            Text(
              extent={{0,-6},{0,-18}},
              lineColor={0,0,0},
              textString="Resource 2")}),
          experiment(StopTime=10),
          experimentSetupOutput);
      ...
      equation
        ...
        connect(release1.outPort, free1.inPort[1]) annotation (Line(
            points={{-20,1},{-20,-4},{-36,-4},{-36,2.416},{-36,51.3459},{-36,66},{-1,
                66},{-1,58}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        connect(release2.outPort, free1.inPort[2]) annotation (Line(
            points={{20,1},{20,-4},{36,-4},{36,4.7075},{36,44.459},{36,66},{1,66},{1,
                58}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        ...
        connect(release4.outPort, free2.inPort[2]) annotation (Line(
            points={{20,-85},{20,-90},{36,-90},{36,-82},{36,-33.8047},{36,-20},{1,-20},
                {1,-28}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        ...
        connect(ready1.outPort, idle1.inPort[1]) annotation (Line(
            points={{-76,-81},{-76,-88},{-96,-88},{-96,-75.0213},{-96,-61.3129},{-96,
                57.3594},{-96,80},{-76,80},{-76,64}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        ...
        connect(requesting3.activePort, reqest3.conditionPort) annotation (Line(
            points={{-71.28,-16},{-71.28,-16},{-40,-16},{-40,-35.2305},{-40,-52},{-25,
                -52}},
            color={255,0,255},
            smooth=Smooth.Bezier));
        ...
        connect(fallingEdge.y, release3.conditionPort) annotation (Line(
            points={{-55.6,-60},{-50,-60},{-50,-70},{-50,-80},{-36.8164,-80},{-25,-80}},
            color={255,0,255},
            smooth=Smooth.Bezier));

        connect(fallingEdge.y, release1.conditionPort) annotation (Line(
            points={{-55.6,-60},{-50,-60},{-50,-44.5481},{-50,-12.4063},{-50,6},{-25,
                6}},
            color={255,0,255},
            smooth=Smooth.Bezier));
    ...
    "Examples demonstrating wrong Modelica_StateGraph2s and the error messages that appear in such cases"
      ...
      connect(initialStep.outPort[1],T1. inPort)
        ...
        connect(T2.outPort,step3. inPort[1]) annotation (Line(
            ...
            smooth=Smooth.Bezier));
        connect(step3.outPort[1],T3. inPort) annotation (Line(
            points={{-41.3333,-40.6},{-41.3333,-46},{-31.3581,-46},{-10,-46},{
              -10,-27.7969},{-10,-6}},
            color={0,0,0},
            smooth=Smooth.Bezier));
      ...
      equation
        ...
        connect(step3.outPort[1], T2.inPort) annotation (Line(
            ...
            smooth=Smooth.Bezier));
        connect(parallel.entry[1], step2.inPort[1]) annotation (Line(
            points={{-1.9,39.5},{-1.9,34},{-9.5536,34},{-20,34},{-20,25.5625},{
              -20,4}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        connect(parallel.entry[2], step3.inPort[1]) annotation (Line(
        ...
        connect(T2.outPort, step4.inPort[1]) annotation (Line(
            ...
            smooth=Smooth.Bezier));
        connect(parallel.outPort[1], T3.inPort) annotation (Line(
            points={{0,-47.125},{0,-54},{9.7754,-54},{39.1016,-54},{56,-54},{56,
              -38.918},{56,-2}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        connect(T3.outPort, step1.inPort[1]) annotation (Line(
            ...
            smooth=Smooth.Bezier));
        connect(step2.outPort[1], parallel.exit[1]) annotation (Line(
            points={{-20,-4.6},{-20,-21.7518},{-20,-32},{-10.4551,-32},{-1.9,
              -32},{-1.9,-42.0625}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        connect(step4.outPort[1], parallel.exit[2]) annotation (Line(
      ...
      model NoInitialStep "An initial step is missing"
        ...
        initialStep=false)
          annotation (Placement(transformation(extent={{-4,44},{4,52}})));
        annotation (__Dymola_inhibitCheck=true, Diagram(coordinateSystem(preserveAspectRatio=true, extent={{-100,
                -100},{100,100}}),         graphics),
          Documentation(info="<html>
      ...
      connect(initialStep.outPort[1], T1.inPort)
        ...
        connect(T2.outPort, step3.inPort[1]) annotation (Line(
            ...
            smooth=Smooth.Bezier));
        connect(step3.outPort[1], T3.inPort) annotation (Line(
            points={{0,-24.6},{0,-30},{8.43405,-30},{16.6406,-30},{30,-30},{30,
              -15.3516},{30,10}},
            color={0,0,0},
            smooth=Smooth.Bezier));
      connect(T3.outPort, initialStep.inPort[1])
                                             annotation (Line(
            points={{30,19},{30,48.1885},{30,60},{16.4573,60},{10.8984,60},{0,
              60},{0,52}},
            color={0,0,0},
            smooth=Smooth.Bezier));
      end NoInitialStep;
      ...
      equation
        ...
        connect(step4.outPort[1], T6.inPort) annotation (Line(
            ...
            smooth=Smooth.None));
        connect(T5.outPort, parallel.resume[1]) annotation (Line(
            points={{-66,-17},{-66,-17},{-66,-26.125},{-57.3594,-26.125},{-38,
              -26.125}},
            color={0,0,0},
            smooth=Smooth.Bezier));
      ...
      equation
        connect(step3.outPort[1], T2.inPort) annotation (Line(
            ...
            smooth=Smooth.Bezier));
        connect(parallel.entry[1], step2.inPort[1]) annotation (Line(
            points={{-7.9,37.5},{-7.9,32},{-14.2197,32},{-21,32},{-21,24.6875},
              {-21,8}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        connect(parallel.entry[2], step3.inPort[1]) annotation (Line(
      ...
      equation
        ...
        connect(step4.outPort[2], T5.inPort) annotation (Line(
            ...
            smooth=Smooth.Bezier));
        connect(T5.outPort, step1.inPort[1]) annotation (Line(
            points={{52,-1},{52,70.8145},{52,82},{38.4603,82},{4.02539,82},{-6,
              82},{-6,74}},
            color={0,0,0},
            smooth=Smooth.Bezier));
      end UnsafeParallel1;
      ...
      equation
        ...
        connect(step5.outPort[1], T4.inPort) annotation (Line(
            ...
            smooth=Smooth.Bezier));
        connect(parallel.outPort[1], T5.inPort) annotation (Line(
            points={{-6,-49.125},{-6,-60},{7.2989,-60},{36.4238,-60},{52,-60},{
              52,-43.8223},{52,6}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        connect(T5.outPort, step5.inPort[1]) annotation (Line(
        ...
        connect(step1.outPort[1], parallel.exit[1]) annotation (Line(
            points={{-20,-24.6},{-20,-31.1037},{-20,-38},{-13.1229,-38},{-7.9,
              -38},{-7.9,-44.0625}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        connect(step4.outPort[1], parallel.exit[2]) annotation (Line(
            points={{10,-24.6},{10,-29.5465},{10,-38},{3.3418,-38},{-4,-38},{-4,
              -44.0625},{-4.1,-44.0625}},
            color={0,0,0},
            smooth=Smooth.Bezier));
      ...
      equation
        ...
        connect(step5.outPort[1], T4.inPort) annotation (Line(
            ...
            smooth=Smooth.Bezier));
        connect(parallel.outPort[1], T5.inPort) annotation (Line(
            points={{-6,-49.125},{-6,-60},{6.42188,-60},{34,-60},{52,-60},{52,
              -43.3711},{52,6}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        connect(T5.outPort, step5.inPort[1]) annotation (Line(
            points={{52,15},{52,77.5488},{52,90},{35.5601,90},{8.5,90},{-6,90},
              {-6,76}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        connect(parallel.entry[1], step2.inPort[1]) annotation (Line(
            points={{-7.9,37.5},{-8,37.5},{-8,30},{-13.1094,30},{-20,30},{-20,
              16}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        connect(parallel.entry[2], step3.inPort[1]) annotation (Line(
            ...
            smooth=Smooth.Bezier));
        connect(T1.outPort, step3.inPort[2]) annotation (Line(
            points={{10,-35},{10,-42},{18,-42},{26,-42},{26,-33.8289},{26,
              17.7656},{26,30},{18.6758,30},{11,30},{11,22}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        connect(step1.outPort[1], parallel.exit[1]) annotation (Line(
      ...
      equation
        ...
        connect(parallel.outPort[1], T5.inPort) annotation (Line(
            ...
            smooth=Smooth.Bezier));
        connect(T5.outPort, step5.inPort[1]) annotation (Line(
            points={{52,15},{52,77.7686},{52,90},{36.678,90},{8.89648,90},{-6,
              90},{-6,76}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        connect(parallel.entry[1], step2.inPort[1]) annotation (Line(
            points={{-7.9,37.5},{-8,37.5},{-8,30},{-17.5391,30},{-30,30},{-30,
              16}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        connect(parallel.entry[2], step3.inPort[1]) annotation (Line(
            ...
            smooth=Smooth.Bezier));
        connect(step1.outPort[1], parallel.exit[1]) annotation (Line(
            points={{-30,-24.6},{-30,-38},{-18.6694,-38},{-14.8938,-38},{-7.9,
              -38},{-7.9,-44.0625}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        connect(step6.outPort[1], parallel.exit[2]) annotation (Line(
      ...
      equation
        ...
        connect(step5.outPort[1], T4.inPort) annotation (Line(
            ...
            smooth=Smooth.Bezier));
        connect(parallel.outPort[1], T5.inPort) annotation (Line(
            points={{-6,-49.125},{-6,-60},{7.091,-60},{37.1035,-60},{52,-60},{
              52,-44.4668},{52,6}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        connect(T5.outPort, step5.inPort[1]) annotation (Line(
        ...
        connect(parallel.entry[1], step2.inPort[1]) annotation (Line(
            ...
            smooth=Smooth.Bezier));
        connect(parallel.entry[2], step3.inPort[1]) annotation (Line(
            points={{-4.1,37.5},{-4,34},{-4,30},{3.54688,30},{10,30},{10,
              21.5645},{10,16}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        connect(step1.outPort[1], parallel.exit[1]) annotation (Line(
            points={{-20,-24.6},{-20,-30.4363},{-20,-38},{-13.7846,-38},{-7.9,
              -38},{-7.9,-44.0625}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        connect(step4.outPort[1], parallel.exit[2]) annotation (Line(
            points={{10,-24.6},{10,-29.1016},{10,-38},{2.67188,-38},{-4,-38},{
              -4,-44.0625},{-4.1,-44.0625}},
            color={0,0,0},
            smooth=Smooth.Bezier));
      ...
      equation
        ...
        connect(step2.outPort[1], T2.inPort) annotation (Line(
            ...
            smooth=Smooth.Bezier));
        connect(T2.outPort, step3.inPort[1]) annotation (Line(
            points={{20,-39},{20,-52},{30.418,-52},{33.5429,-52},{48,-52},{48,
              -37.6445},{48,32.6038},{48,46},{32.8994,46},{11.7785,46},{1,46},{
              1,36}},
            color={0,0,0},
            smooth=Smooth.Bezier));
        connect(step1.outPort[1], T3.inPort) annotation (Line(
...
protected
  ...
  Modelica_StateGraph2.Step waitStep(
    ...
    final nIn=1,
    final nOut=1) annotation (Placement(transformation(extent={{-4,21},{4,29}})));
  Modelica_StateGraph2.Blocks.MathBoolean.OnDelay onDelay(    final delayTime=waitTime)
...
Modelica_StateGraph2.Internal.Interfaces.Step_out outPort[nOut] if use_outPort
    "If enabled, port for one or more output transitions"
...
Modelica_StateGraph2.Internal.Interfaces.Composite_suspend suspend[nSuspend] if
    use_suspend "If enabled, port for zero, one or more suspend transitions"                 annotation (Placement(
      iconTransformation(
      extent={{-66,59},{-60,31}})));
Modelica_StateGraph2.Internal.Interfaces.Composite_resume resume[nResume] if
    use_suspend "If enabled, port for zero, one or more resume transitions"               annotation (Placement(
      iconTransformation(
      extent={{-63,-31},{-57,-59}})));
...
Modelica_StateGraph2.Internal.Interfaces.ExitPort exit[nExit] if use_outPort
    "If enabled, synchronization port for one or more branches (Step or Parallel components must be connected to this port)"
                                                   annotation (Placement(transformation(extent={{-6,-74},
            {6,-70}}),        iconTransformation(extent={{-6,-75},{6,-71}})));
...
annotation (defaultComponentName="step1",Diagram(coordinateSystem(
      ...
      grid={0.5,0.5}), graphics={Text(
          ...
          extent={{3,-70},{14,-73}},
          lineColor={0,0,0},
          textString="exit")}),   Icon(coordinateSystem(
      extent={{-60,-80},{60,80}},
      initialScale=1,
      grid={0.5,0.5},
      preserveAspectRatio=false,
...
<tr><td>use_inPort=<b>true</b><br>
    ...
    uses(Modelica_StateGraph2(version="0.8")));
...
<img src=\"../Images/StateGraph/Elements/PartialParallel.png\">
  ...
  Modelica_StateGraph2.Internal.Interfaces.Step_in inPort[nIn] if use_inPort
    "If enabled, port for one or more input transitions"
                                                        annotation (Placement(iconTransformation(extent={{-40,191},
            {40,209}})));
  Modelica_StateGraph2.Internal.Interfaces.Step_out outPort[nOut] if use_outPort
...
equation
  ...
  block TriggeredAdd
    ...
    Modelica.Blocks.Interfaces.IntegerInput set if use_set annotation (Placement(transformation(
          ...
          rotation=270,
          origin={28,98})));
    annotation (defaultComponentName="add1",Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
                -100},{100,100}},
...
<tr><td> 4 </td>
    ...
    model TrigButton
      ...
      annotation (Icon(
          ...
          graphics={Rectangle(
              borderPattern=BorderPattern.Raised,
              extent={{-100,-100},{100,100}},
              fillColor=DynamicSelect({192,192,192}, if buttonState > 0.5 then
                  {255,0,0} else {192,192,192}),
              fillPattern=FillPattern.Solid,
              lineColor={128,128,128},
              ...
              textString="%label")},
            interaction={OnMouseDownSetBoolean(
                              buttonState, true)}), Diagram(coordinateSystem(
              preserveAspectRatio=true,  extent={{-100,-100},{100,100}}), graphics));
    ...
    protected
      ...
      Boolean pre_buttonState(start=false,fixed=true) annotation(HideResult=false);
    equation
    ...
    model PressButton
      ...
      annotation (structurallyIncomplete=true, Icon(
            coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{
                100,100}}),
          graphics={Rectangle(
              borderPattern=BorderPattern.Raised,
              ...
              lineColor={0,0,255},
              textString="%label")},
            interaction={OnMouseDownSetBoolean(buttonState,true), OnMouseUpSetBoolean(buttonState,false)}), Diagram(coordinateSystem(
              preserveAspectRatio=true,  extent={{-100,-100},{100,100}}), graphics));
    ...
    model ToggleButton
      ...
      annotation (Icon(
          ...
          graphics={Rectangle(
              extent={{-100,-100},{100,100}},
              fillColor=DynamicSelect({192,192,192}, if y > 0.5 then {255,0,0} else
                        {192,192,192}),
              borderPattern=BorderPattern.Raised,
              fillPattern=FillPattern.Solid,
              lineColor={128,128,128},
...
Connector with one input signal of type Boolean.
  ...
  partial block PartialTriggeredSet
    ...
    parameter Boolean rising = true
        "=true, if rising input triggers evaluation"
          annotation(Dialog(group="Select exactly one check box"),Evaluate=true, HideResult=true, choices(__Dymola_checkBox=true));
    ...
    parameter Boolean use_guard = false "= true, if guard enabled"
          annotation(Dialog(group="Other options"),Evaluate=true, HideResult=true, choices(__Dymola_checkBox=true));
    input Boolean guard=true "y not changing, if guard=false (time varying)" annotation(Dialog(group="Other options",enable=use_guard));
    ...
    annotation (defaultComponentName="set1",Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
              -100},{300,100}},
          grid={1,1}),           graphics), Icon(coordinateSystem(
          preserveAspectRatio=false,
          extent={{-100,-100},{300,100}},
          grid={1,1}), graphics={
            ...
            Line(
              visible=changing,
              points={{-85,-17},{-74,-17},{-74,16},{-53,16},{-53,-17},{-38,-17}},
              color={255,0,255},
              smooth=Smooth.None),
            Line(
              visible=falling,
  ...
  equation
    ...
    record ActiveSetIntegerRecord
      ...
      Integer expr=0 "y = if active then expr else y_default (time varying)" annotation(Dialog);
...
",     HideResult=true);
    ...
    connector Step_out_base "Output port of a step without icon"
      output Boolean available
        "= true, if step is active and firing is possible"                        annotation (HideResult=true);
...
",     HideResult=true);
    ...
    connector Step_in "Input port of a step"
      ...
      annotation (defaultComponentName="inPort",
    ...
    connector Step_out "Output port of a step"
      ...
      annotation (defaultComponentName="outPort",Icon(
          coordinateSystem(extent={{-100,-100},{100,100}}, preserveAspectRatio=false),
            graphics={Polygon(
    ...
    connector Composite_resume "Resume port of a composite step"
       extends Step_in_base;
      annotation (defaultComponentName="resume",Diagram(coordinateSystem(preserveAspectRatio=true,  extent={{-140,
                -30},{140,30}},
            grid={1,1}), graphics),
                                  Icon(coordinateSystem(preserveAspectRatio=false,
    ...
    connector Composite_suspend "Suspend port of a Composite"
       extends Step_out_base;
      annotation (defaultComponentName="suspend",Diagram(coordinateSystem(
            preserveAspectRatio=false,
...
",     HideResult=true);
    ...
    connector Transition_in "Input port of a transition"
      ...
      annotation (defaultComponentName="inPort",Icon(
          coordinateSystem(extent={{-100,-100},{100,100}}, preserveAspectRatio=false),
            graphics={Ellipse(
              extent={{-100,100},{100,-100}},
              lineColor={0,0,0},
    ...
    connector EntryPort
      ...
      annotation (defaultComponentName="entry",Icon(
          coordinateSystem(extent={{-60,-20},{60,20}},     preserveAspectRatio=true,
            grid={0.5,0.5}), graphics={Ellipse(
              extent={{-60,15},{60,-15}},
              lineColor={0,0,0},
              fillColor={95,95,95},
              fillPattern=FillPattern.Solid)}),            Diagram(
          coordinateSystem(extent={{-60,-20},{60,20}},     preserveAspectRatio=false,
            grid={0.5,0.5}), graphics={Ellipse(
    ...
    connector ExitPort
      ...
      annotation (defaultComponentName="exit",Icon(
          coordinateSystem(extent={{-60,-20},{60,20}},     preserveAspectRatio=true,
